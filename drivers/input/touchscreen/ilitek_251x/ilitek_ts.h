...
/* Ilitek debug options are disabled. If you wish to add them,
 * make sure you include the below defines in this header file:
...
extern unsigned char ilitek_hwmajor;
extern unsigned char ilitek_hwminor;
