...
/*
 * Feature to control power during suspend/resume
 * enable it to turn off touch power on suspend
 * and turn on on resume
 * default: disable
 */
/* #define FTS_POWER_SOURCE_OFF_ON_SUSPEND_EN      1 */
 ...
 * NOTE: if FTS_GET_VENDOR_ID_NUM >= 1, it's the fw corresponding with
 * FTS_VENDOR_1_ID
 */
#define FTS_UPGRADE_FW_APP		CONFIG_TOUCHSCREEN_FTS_UPGRADE_FW_APP

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_2_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_APP		CONFIG_TOUCHSCREEN_FTS_UPGRADE_FW_APP

/*
 * if FTS_GET_VENDOR_ID_NUM == 3, fw corrsponding with FTS_VENDOR_3_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_APP		CONFIG_TOUCHSCREEN_FTS_UPGRADE_FW_APP
