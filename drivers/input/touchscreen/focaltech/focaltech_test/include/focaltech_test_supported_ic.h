...
int FT8607_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
#elif (FTS_CHIP_TEST_TYPE == FT8716_TEST)
boolean FT8716_StartTest(void);
int FT8716_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT3D47_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT5X46_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT6X36_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT5822_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT8006_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT8736_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FTE716_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT8606_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
...
int FT3C47_get_test_data(char *pTestData);      /* pTestData, External
						 * application for memory, buff
						 * size >= 1024*80
						 */
