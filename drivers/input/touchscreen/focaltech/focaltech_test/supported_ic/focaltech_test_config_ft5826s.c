...
* Created: 2015-07-14
*
* Abstract: Set Config for FT5X46\FT5X46i\FT5526\FT3X17\FT5436\FT3X27\
*	    FT5526i\FT5416\FT5426\FT5435
*
************************************************************************/
...
void OnInit_FT5822_TestItem(char *strIniFile)
{
	...
	/* ///////////////////////////////// RX_SHORT_TEST */
	/* GetPrivateProfileString("TestItem","RX_SHORT_TEST",
	 *			   "1",str,strIniFile);
	 */
	/* g_stCfg_FT5822_TestItem.RX_SHORT_TEST = fts_atoi(str); */

	/* ///////////////////////////////// TX_SHORT_TEST */
	/* GetPrivateProfileString("TestItem","TX_SHORT_TEST",
	 *			   "1",str,strIniFile);
	 */
...
void OnInit_FT5822_BasicThreshold(char *strIniFile)
{
	...
	GetPrivateProfileString("Basic_Threshold", "FW_VER_VALUE",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.FW_VER_VALUE = fts_atoi(str);

	/* //////////////////////////////////////////////// Factory ID */
	GetPrivateProfileString("Basic_Threshold", "Factory_ID_Number",
				"255", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.Factory_ID_Number = fts_atoi(str);

	/* //////////////////////////////////////////////// Project Code Test */
	GetPrivateProfileString("Basic_Threshold", "Project_Code",
				" ", str, sizeof(str), strIniFile);
	/* g_stCfg_FT5822_BasicThreshold.Project_Code.Format("%s", str); */
	snprintf(g_stCfg_FT5822_BasicThreshold.Project_Code, 32, "%s", str);

	/* //////////////////////////////////////////////// IC Version */
	GetPrivateProfileString("Basic_Threshold", "IC_Version",
				"3", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.IC_Version = fts_atoi(str);

	/* //////////////////////////////////////////////// LCM ID */
	GetPrivateProfileString("Basic_Threshold", "LCM_ID",
	...
	GetPrivateProfileString("Basic_Threshold", "RawDataTest_LowFreq",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.RawDataTest_SetLowFreq = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "RawDataTest_HighFreq",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.RawDataTest_SetHighFreq = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "Adc_Detect_Max",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.AdcDetect_Max = fts_atoi(str);

	/* GetPrivateProfileString("Basic_Threshold","RxShortTest_Min",
	 *			   "1000", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RxShortTest_Min = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","RxShortTest_Max",
	 *			   "32800", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RxShortTest_Max = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","TxShortTest_Min",
	 *			   "300", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.TxShortTest_Min = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","TxShortTest_Max",
	 *			   "3000", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.TxShortTest_Max = fts_atoi(str); */

	GetPrivateProfileString("Basic_Threshold", "SCapCbTest_OFF_Min",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.SCapCbTest_OFF_Min = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "SCapCbTest_OFF_Max",
				"240", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.SCapCbTest_OFF_Max = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "SCapCbTest_ON_Min",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.SCapCbTest_ON_Min = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "SCapCbTest_ON_Max",
				"240", str, sizeof(str), strIniFile);
	...
	GetPrivateProfileString("Basic_Threshold",
				...
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.SCapCbTest_SetWaterproof_OFF =
	    fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold",
				"ScapCBTest_SetWaterproof_ON",
				"240", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.SCapCbTest_SetWaterproof_ON =
	    fts_atoi(str);

	/* GetPrivateProfileString("Basic_Threshold","SCapDifferTest_Min",
	 *			   "100", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.SCapDifferTest_Min = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","SCapDifferTest_Max",
	 *			   "10000", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.SCapDifferTest_Max = fts_atoi(str); */
	/* GetPrivateProfileString("Basic_Threshold","SCapDifferTest_CbLevel",
	 *			   "2", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.SCapDifferTest_CbLevel =
	 * fts_atoi(str);
	 */
	...
	GetPrivateProfileString("Basic_Threshold", "ChannelNumTest_TxNum",
				"13", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.ChannelNumTest_TxNum = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "ChannelNumTest_RxNum",
	...
	GetPrivateProfileString("Basic_Threshold", "IntPinTest_RegAddr",
				"79", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.IntPinTest_RegAddr = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "NoiseTest_Max",
				"20", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_Max = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "NoiseTest_Frames",
				"32", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_Frames = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "NoiseTest_Time",
				"1", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_Time = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "NoiseTest_SampeMode",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_SampeMode = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "NoiseTest_NoiseMode",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_NoiseMode = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "NoiseTest_ShowTip",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.NoiseTest_ShowTip = fts_atoi(str);

	GetPrivateProfileString("Basic_Threshold", "NoiseTest_GloveMode",
				"0", str, sizeof(str), strIniFile);
	...
	GetPrivateProfileString("Basic_Threshold", "GloveNoiseTest_Coefficient",
				"100", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.GloveNoiseTest_Coefficient =
	    fts_atoi(str);
	/* GetPrivateProfileString("Basic_Threshold","SCapClbTest_Frame",
	 *			   "3", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.SCapClbTest_Frame = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","SCapClbTest_Max",
	 *			   "1000", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.SCapClbTest_Max = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","RxCrosstalkTest_Min",
	 *			   "-100", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RxCrosstalkTest_Min = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold","RxCrosstalkTest_Max",
	 *			   "300", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RxCrosstalkTest_Max = fts_atoi(str); */

	/* GetPrivateProfileString("Basic_Threshold",
	 *			   "RawDataRxDeviationTest_Max",
	 *			   "500", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RawDataRxDeviationTest_Max =
	 * fts_atoi(str);
	 */

	/* GetPrivateProfileString("Basic_Threshold",
	 *			   "RawDataUniformityTest_Percent",
	 *			   "90", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.RawDataUniformityTest_Percent =
	 * fts_atoi(str);
	 */

	/* GetPrivateProfileString("Basic_Threshold","RxLinearityTest_Max",
	 * "50", str, sizeof(str),strIniFile);
	 */
	...
	/* GetPrivateProfileString("Basic_Threshold",
	 *			   "DifferDataUniformityTest_Percent",
	 *			   "80", str, sizeof(str),strIniFile);
	 */
	/* g_stCfg_FT5822_BasicThreshold.DifferDataUniformityTest_Percent =
	 *fts_atoi(str);
	 */

	GetPrivateProfileString("Basic_Threshold", "WeakShortTest_CG",
				"2000", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.WeakShortTest_CG = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "WeakShortTest_CC",
				"2000", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.WeakShortTest_CC = fts_atoi(str);
	/* GetPrivateProfileString("Basic_Threshold",
	 * "WeakShortTest_ChannelNum","38", str, sizeof(str),strIniFile);
	 */

	/* g_stCfg_FT5822_BasicThreshold.WeakShortTest_ChannelNum =
	 * fts_atoi(str);
	 */
	...
	GetPrivateProfileString("Basic_Threshold", "CMTest_Check_Min",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.CMTest_CheckMin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CMTest_Check_Max",
				"0", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.CMTest_CheckMax = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CMTest_Min_Hole",
				"0.5", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.CMTest_MinHole = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CMTest_Max_Hole",
				"5", str, sizeof(str), strIniFile);
	...
	GetPrivateProfileString("Basic_Threshold", "RawdataMarginTest_Max",
				"1", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.RawdataMarginTest_Max = fts_atoi(str);

	/* panel differ */
	GetPrivateProfileString("Basic_Threshold", "PanelDifferTest_Min",
				"150", str, sizeof(str), strIniFile);
	...
	g_stCfg_FT5822_BasicThreshold.PanelDiffer_UniformityTest_Tx_Hole =
	    fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold",
				"PanelDiffer_UniformityTest_Rx_Hole",
				"20", str, sizeof(str), strIniFile);
	g_stCfg_FT5822_BasicThreshold.PanelDiffer_UniformityTest_Rx_Hole =
	    fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold",
				"PanelDiffer_UniformityTest_MinMax_Hole",
				"70", str, sizeof(str), strIniFile);
