...
void set_max_channel_num(void)
{
	...
	FTS_TEST_DBG("MaxTxNum = %d, MaxRxNum = %d. ",
...
void OnGetTestItemParam(char *strItemName, char *strIniFile, int iDefautValue)
{
	...
	snprintf(str_tmp, sizeof(str_tmp), "%d", iDefautValue);
	GetPrivateProfileString("Basic_Threshold", strItemName, str_tmp,
				strValue, sizeof(strValue), strIniFile);
...
void OnInit_InvalidNode(char *strIniFile)
{
	...
	for (i = 0; i < TX_NUM_MAX; i++) {
		for (j = 0; j < RX_NUM_MAX; j++) {
			snprintf(strTemp, sizeof(strTemp),
...
void OnInit_DThreshold_SCapCbTest(char *strIniFile)
{
	...
	for (i = 0; i < 2; i++) {
		for (j = 0; j < g_ScreenSetParam.iUsedMaxRxNum; j++) {
			g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max[i][j] =
			    MaxValue;
		}
	}
	for (i = 0; i < 2; i++) {
...
void OnInit_DThreshold_ForceTouch_SCapRawDataTest(char *strIniFile)
{
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapRawData_OFF_Max_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapRawData_OFF_Min_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapRawData_ON_Max_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapRawData_ON_Min_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
...
void OnInit_DThreshold_ForceTouch_SCapCbTest(char *strIniFile)
{
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapCB_ON_Max_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapCB_ON_Min_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapCB_OFF_Max_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
	...
	for (i = 0; i < 1; i++) {
		snprintf(str, sizeof(str), "ForceTouch_ScapCB_OFF_Min_%d",
			 (i + 1));
		dividerPos =
		    GetPrivateProfileString("SpecialSet", str, "NULL", strTemp,
					    sizeof(strTemp), strIniFile);
...
void OnThreshold_VkAndVaRawDataSeparateTest(char *strIniFile)
{
	...
	GetPrivateProfileString("Basic_Threshold", "RawDataTest_Max_VKey",
				"11000", str, sizeof(str), strIniFile);
	MaxValue_Vkey = fts_atoi(str);
