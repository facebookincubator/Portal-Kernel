...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readCompensationDataHeader(u8 type, struct DataHeader *header, u64 *address)
{
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readMutualSenseGlobalData(u64 *address, struct MutualSenseData *global)
{
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readMutualSenseNodeData(u64 address, struct MutualSenseData *node)
{
	int ret;
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readMutualSenseCompensationData(u8 type, struct MutualSenseData *data)
{
	int ret;
	u64 address;
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readSelfSenseGlobalData(u64 *address, struct SelfSenseData *global)
{
	int ret;
	u8 data[COMP_DATA_GLOBAL];
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readSelfSenseNodeData(u64 address, struct SelfSenseData *node)
{
	int ret;
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readSelfSenseCompensationData(u8 type, struct SelfSenseData *data)
{
	int ret;
	u64 address;
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readTotMutualSenseGlobalData(u64 *address,
				 struct TotMutualSenseData *global)
{
	int ret;
	u8 data[COMP_DATA_GLOBAL];
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readTotMutualSenseNodeData(u64 address, struct TotMutualSenseData *node)
{
	int ret, i;
	int size = node->header.force_node * node->header.sense_node;
...
/**
  ...
  * data from the buffer and store it in a struct TotMutualSenseData variable
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readTotMutualSenseCompensationData(u8 type, struct TotMutualSenseData *data)
{
	int ret;
	u64 address;
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readTotSelfSenseGlobalData(u64 *address, struct TotSelfSenseData *global)
{
	int ret;
	u8 data[COMP_DATA_GLOBAL];
...
/**
  ...
  * @return OK if success or an error code which specify the type of error
  */
int readTotSelfSenseNodeData(u64 address, struct TotSelfSenseData *node)
{
	int size = node->header.force_node * 2 + node->header.sense_node * 2;
...
/**
  ...
  * data from the buffer and store it in a struct TotSelfSenseData variable
  * @param type type of TOT MS Initialization data to read @link load_opt Load
  * Host Data Option @endlink
  * @param data pointer to a variable which will contain the TOT MS
  * initialization data
  * @return OK if success or an error code which specify the type of error
  */
int readTotSelfSenseCompensationData(u8 type, struct TotSelfSenseData *data)
{
	int ret;
	u64 address;
