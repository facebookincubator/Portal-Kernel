...
struct MutualSenseData {
	struct DataHeader header;	/* /< Header */
...
int readCompensationDataHeader(u8 type, struct DataHeader *header,
				      u64 *address);
...
int readTotMutualSenseCompensationData(u8 type,
				       struct TotMutualSenseData *data);
