...
/** @defgroup second_level Second Level Error Code
  ...
  * @{
  */
#define ERROR_DISABLE_INTER		((int)0x80000200) /* /< unable to
							 * disable the interrupt
							 */
#define ERROR_ENABLE_INTER		((int)0x80000300) /* /< unable to
							 * activate the
							 * interrupt
							 */
#define ERROR_READ_CONFIG		((int)0x80000400) /* /< failed to read
							 * config memory
							 */
#define ERROR_GET_OFFSET		((int)0x80000500) /* /< unable to read
							 * an offset from memory
							 */
...
#define ERROR_SET_FEATURE_FAIL		((int)0x80000A00) /* /< setting a
							 ...
							 * failed
							 */
#define ERROR_SYSTEM_RESET_FAIL		((int)0x80000B00) /* /< the command
							 * SYSTEM RESET
							 * failed
							 */
