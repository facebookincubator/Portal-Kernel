...
extern struct SysInfo systemInfo;/* /< Global System Info variable,
				  *  accessible in all the driver
				  */
extern struct TestToDo tests;
...
#define FTS_TS_DRV_VERSION	"5.2.13_update3"/* driver version string
						 * format
						 */
#define FTS_TS_DRV_VER		0x05020C03	/* driver version u32 format */
...
#undef DRIVER_TEST	/* /< if defined allow to use and test special functions
			 * of the driver and fts_lib from command shell (useful
...
/* **** FEATURES USED FOR DEBUG ONLY **** */

#ifdef CONFIG_TOUCHSCREEN_ST_DEBUG

/* Enable the support of fts_proc */
#define FTS_PROC_ENABLED
/* Enable the support of stm_fts_cmd */
#define STM_FTS_CMD_ENABLED
...
/* **** PANEL SPECIFICATION **** */
#define X_AXIS_MAX	799	/* /< Max X coordinate of the display */
#define X_AXIS_MIN	0	/* /< min X coordinate of the display */
#define Y_AXIS_MAX	1279	/* /< Max Y coordinate of the display */
...
/*
  ...
  */
struct fts_ts_info;
#define TAG "[ FTS ]"	/* /< forward the definition of the label used
