...
static const struct reg_default cs47l35_reg_default[] = {
	...
	{ 0x00000400, 0x0003 }, /* R1024 (0x400) - Output Enables 1 */
	...
	{ 0x00000411, 0x0074 }, /* R1041 (0x411) - DAC Digital Volume 1L */
	{ 0x00000413, 0x0001 }, /* R1043 (0x413) - Noise Gate Select 1L */
	{ 0x00000414, 0x0080 }, /* R1044 (0x414) - Output Path Config 1R */
	{ 0x00000415, 0x0074 }, /* R1045 (0x415) - DAC Digital Volume 1R */
	...
	{ 0x00000ec4, 0x0003 }, /* R3780 (0xec4) - HPLPF2_1 */
	{ 0x00000ec5, 0xf54f }, /* R3781 (0xec5) - HPLPF2_2 */
	{ 0x00000ec8, 0x0001 }, /* R3784 (0xec8) - HPLPF3_1 */
	{ 0x00000ec9, 0xf54f }, /* R3785 (0xec9) - HPLPF3_2 */
	...
	/* Need to read Board ID from hardware instead of cached value */
