...
static struct clk_freq_tbl ftbl_blsp_qup_spi_apps_clk_src[] = {
	...
	F(  12500000, gpll0_out_main,   12,    1,     4),
...
static int msm_gcc_8998_probe(struct platform_device *pdev)
{
	...
	/* SKIP Handoff for LN_BB_CLK2 */
	ln_bb_clk2.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk2_ao.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk2_pin.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk2_pin_ao.c.flags |= CLKFLAG_SKIP_HANDOFF;

	/* SKIP Handoff for LN_BB_CLK3 */
	ln_bb_clk3.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk3_ao.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk3_pin.c.flags |= CLKFLAG_SKIP_HANDOFF;
	ln_bb_clk3_pin_ao.c.flags |= CLKFLAG_SKIP_HANDOFF;
