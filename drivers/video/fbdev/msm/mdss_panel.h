...
struct mdss_panel_info {
	...
	/* Add delay before send RST sequence on LCD off */
	u32 delay_send_rst_ms;

	/* delay time after backlight turn off */
	u32 backlight_post_off_sleep;
};
...
struct mdss_panel_ops {
	struct list_head item;
	char name[MDSS_MAX_PANEL_LEN];
	int instance_id;

	int (*power_on)(struct mdss_panel_ops *ops, bool on);
	int (*video_on)(struct mdss_panel_ops *ops, bool on,
