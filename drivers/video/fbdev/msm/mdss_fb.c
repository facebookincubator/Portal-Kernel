...
#ifdef CONFIG_FB_EXT_DISPLAY_UPDATE_PANEL_INFO_FOR_RECONFIGURE
		/*
		 * In case the panel_reconfig is required, update the
		 * panel_info so that wrong parameter is not used
		 * before reconfig is finished
		 */
