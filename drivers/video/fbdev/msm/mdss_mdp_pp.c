...
static inline const char *mdss_mdp_csc_type_to_string(u32 csc_type)
{
	switch (csc_type) {
	case MDSS_MDP_CSC_YUV2RGB_601L:
		return "YUV2RGB_601L";
	case MDSS_MDP_CSC_YUV2RGB_601FR:
		return "YUV2RGB_601FR";
	case MDSS_MDP_CSC_YUV2RGB_709L:
		return "YUV2RGB_709L";
	case MDSS_MDP_CSC_YUV2RGB_2020L:
		return "YUV2RGB_2020L";
	case MDSS_MDP_CSC_YUV2RGB_2020FR:
		return "YUV2RGB_2020FR";
	case MDSS_MDP_CSC_RGB2YUV_601L:
		return "RGB2YUV_601L";
	case MDSS_MDP_CSC_RGB2YUV_601FR:
		return "RGB2YUV_601FR";
	case MDSS_MDP_CSC_RGB2YUV_709L:
		return "RGB2YUV_709L";
	case MDSS_MDP_CSC_RGB2YUV_709FR:
		return "RGB2YUV_709FR";
	case MDSS_MDP_CSC_RGB2YUV_2020L:
		return "RGB2YUV_2020L";
	case MDSS_MDP_CSC_RGB2YUV_2020FR:
		return "RGB2YUV_2020FR";
	case MDSS_MDP_CSC_YUV2YUV:
		return "YUV2YUV";
	case MDSS_MDP_CSC_RGB2RGB:
		return "RGB2RGB";
	case MDSS_MDP_CSC_RGB2RGB_L:
		return "RGB2RGB_L";
	}
...
static inline const char *mdss_mdp_csc_block_to_string(u32 block)
{
	switch (block) {
	case MDSS_MDP_BLOCK_SSPP:
		return "SSPP 8bit";
...
int mdss_mdp_csc_setup(u32 block, u32 blk_idx, u32 csc_type)
{
	...
	pr_debug("%s: csc type=%s blk=%s idx=%d\n", __func__,
		mdss_mdp_csc_type_to_string(csc_type),
		 mdss_mdp_csc_block_to_string(block), blk_idx);
