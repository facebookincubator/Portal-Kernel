...
static inline const char *hdmi_panel_get_colorimetry_string(u32 info,
							u32 ext_info)
{
	if (info != HDMI_COLORIMETRY_EXTENDED) {
		switch (info) {
		case HDMI_COLORIMETRY_ITU_R_601:
			return "ITU_R_601";
		case HDMI_COLORIMETRY_ITU_R_709:
			return "ITU_R_709";
		default:
			return "COLORIMETRY_DEFAULT";
		}
	} else {
		switch (ext_info) {
		case HDMI_COLORIMETRY_XV_YCC_601:
			return "XV_YCC_601";
		case HDMI_COLORIMETRY_XV_YCC_709:
			return "XV_YCC_709";
		case HDMI_COLORIMETRY_S_YCC_601:
			return "S_YCC_601";
		case HDMI_COLORIMETRY_ADOBE_YCC_601:
			return "ADOBE_YCC_601";
		case HDMI_COLORIMETRY_ADOBE_RGB:
			return "ADOBE_RGB";
		case HDMI_COLORIMETRY_C_YCBCR_BT2020:
			return "C_YCBCR_BT2020";
		case HDMI_COLORIMETRY_YCBCR_BT2020:
			return "YCBCR_BT2020";
		default:
			return "COLORIMETRY_RESERVED";
		}
	}
}
...
static int hdmi_panel_setup_dc(struct hdmi_panel *panel)
{
	...
	pr_info("Deep Color: %s, bitdepth = %d\n",
		...
		bool use_bt2020)
{
	...
	pr_info("%s: avi colorimetry %s\n", __func__,
		hdmi_panel_get_colorimetry_string(avi->colorimetry_info,
