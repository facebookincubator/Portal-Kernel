 ...
 * @bridge_continuous_splash: External bridge with continuous splash enabled
 * @bridge_lp11_init: Enable external bridge during lp11 init
...
struct dsi_display {
	...
	bool bridge_force_hs_clk_lane;
	bool bridge_continuous_splash;
	bool bridge_lp11_init;
