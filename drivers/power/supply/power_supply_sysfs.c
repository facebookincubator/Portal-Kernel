...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(cell_voltage1),
	POWER_SUPPLY_ATTR(cell_voltage2),
	POWER_SUPPLY_ATTR(cell_voltage3),
	POWER_SUPPLY_ATTR(cell_voltage4),
	POWER_SUPPLY_ATTR(charging_current),
	POWER_SUPPLY_ATTR(charging_voltage),
	POWER_SUPPLY_ATTR(remaining_capacity),
	POWER_SUPPLY_ATTR(battery_mode),
	POWER_SUPPLY_ATTR(manufacturer_access),
	POWER_SUPPLY_ATTR(battery_status),
	POWER_SUPPLY_ATTR(charge_current_limit),
	POWER_SUPPLY_ATTR(max_system_voltage),
	POWER_SUPPLY_ATTR(adapter_current_limit_2),
	POWER_SUPPLY_ATTR(adapter_current_limit_1),
	POWER_SUPPLY_ATTR(control3),
	POWER_SUPPLY_ATTR(min_system_voltage),
	POWER_SUPPLY_ATTR(monitor_gauge),
	POWER_SUPPLY_ATTR(disable_charging),
	POWER_SUPPLY_ATTR(vsys_status),
	POWER_SUPPLY_ATTR(adapter_voltage),
	POWER_SUPPLY_ATTR(min_adapter_charge_voltage),
