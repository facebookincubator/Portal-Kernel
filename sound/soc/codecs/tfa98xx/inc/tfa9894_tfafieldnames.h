...
typedef enum nxpTfa9894BfEnumList {
	/* Powerdown control */
	TFA9894_BF_PWDN = 0x0000,
	/* I2C Reset - Auto clear */
	TFA9894_BF_I2CR = 0x0010,
	/* Enable CoolFlux DSP */
	TFA9894_BF_CFE = 0x0020,
	/* Enable Amplifier */
	TFA9894_BF_AMPE = 0x0030,
	/* Enable DCDC Boost converter */
	TFA9894_BF_DCA = 0x0040,
	/* Coolflux configured */
	TFA9894_BF_SBSL = 0x0050,
	/* CoolFlux control over amplifier */
	TFA9894_BF_AMPC = 0x0060,
	/* Interrupt config */
	TFA9894_BF_INTP = 0x0071,
	/* Audio sample reference */
	TFA9894_BF_FSSSEL = 0x0090,
	/* Bypass OCP */
	TFA9894_BF_BYPOCP = 0x00a0,
	/* OCP testing control */
	TFA9894_BF_TSTOCP = 0x00b0,
	/* Vbat protection steepness */
	TFA9894_BF_BSSS = 0x00c0,
	/* Bypass High Pass Filter */
	TFA9894_BF_HPFBYP = 0x00d0,
	/* Enable DPSA */
	TFA9894_BF_DPSA = 0x00e0,
	/* Amplifier input selection */
	TFA9894_BF_AMPINSEL = 0x0101,
	/* Device I2C settings configured */
	TFA9894_BF_MANSCONF = 0x0120,
	/* Execute cold start */
	TFA9894_BF_MANCOLD = 0x0130,
	/* Reaction on BOD */
	TFA9894_BF_MANROBOD = 0x0140,
	/* Enable BOD (only in direct control mode) */
	TFA9894_BF_BODE = 0x0150,
	/* Enable Hysteresis of BOD */
	TFA9894_BF_BODHYS = 0x0160,
	/* BOD filter */
	TFA9894_BF_BODFILT = 0x0171,
	/* BOD threshold */
	TFA9894_BF_BODTHLVL = 0x0191,
	/* Time out SB mute sequence */
	TFA9894_BF_MUTETO = 0x01b0,
	/* Watchdog enable */
	TFA9894_BF_MANWDE = 0x01c0,
	/* Control for FAIM protection */
	TFA9894_BF_OPENMTP = 0x01e0,
	/* Overrule the enabling of VBG for faim erase/write access */
	TFA9894_BF_FAIMVBGOVRRL = 0x01f0,
	/* Audio sample rate Fs */
	TFA9894_BF_AUDFS = 0x0203,
	/* TDM output attenuation */
	TFA9894_BF_INPLEV = 0x0240,
	/* Current sense fractional delay */
	TFA9894_BF_FRACTDEL = 0x0255,
	/* Control for HW manager */
	TFA9894_BF_TDMPRES = 0x02b1,
	/* Amplifier on-off criteria for shutdown */
	TFA9894_BF_AMPOCRT = 0x02d2,
	/* Revision info */
	TFA9894_BF_REV = 0x030f,
	/* PLL external reference clock */
	TFA9894_BF_REFCKEXT = 0x0401,
	/* PLL internal reference clock */
	TFA9894_BF_REFCKSEL = 0x0420,
	/* Master Clock Selection */
	TFA9894_BF_MCLKSEL = 0x0432,
	/* Internal OSC1M off at PWDN */
	TFA9894_BF_MANAOOSC = 0x0460,
	/* Automatic PLL reference clock selection for cold start */
	TFA9894_BF_ACKCLDDIS = 0x0470,
	/* Enable speaker sub-system */
	TFA9894_BF_SPKSSEN = 0x0510,
	/* Enable FAIM sub-system */
	TFA9894_BF_MTPSSEN = 0x0520,
	/* Enable Coolflux watchdog clock */
	TFA9894_BF_WDTCLKEN = 0x0530,
	/* POR */
	TFA9894_BF_VDDS = 0x1000,
	/* PLL Lock */
	TFA9894_BF_PLLS = 0x1010,
	/* OTP alarm */
	TFA9894_BF_OTDS = 0x1020,
	/* OVP alarm */
	TFA9894_BF_OVDS = 0x1030,
	/* UVP alarm */
	TFA9894_BF_UVDS = 0x1040,
	/* OCP amplifier (sticky register, clear on read) */
	TFA9894_BF_OCDS = 0x1050,
	/* Clocks stable */
	TFA9894_BF_CLKS = 0x1060,
	/* MTP busy */
	TFA9894_BF_MTPB = 0x1070,
	/* Lost clock */
	TFA9894_BF_NOCLK = 0x1080,
	/* Cold Start */
	TFA9894_BF_ACS = 0x1090,
	/* Watchdog */
	TFA9894_BF_WDS = 0x10a0,
	/* Amplifier engage */
	TFA9894_BF_SWS = 0x10b0,
	/* Amplifier enable */
	TFA9894_BF_AMPS = 0x10c0,
	/* References enable */
	TFA9894_BF_AREFS = 0x10d0,
	/* Control ADC */
	TFA9894_BF_ADCCR = 0x10e0,
	/* BOD Flag - VDD NOT OK */
	TFA9894_BF_BODNOK = 0x10f0,
	/* DCDC current limiting */
	TFA9894_BF_DCIL = 0x1100,
	/* DCDC active (sticky register, clear on read) */
	TFA9894_BF_DCDCA = 0x1110,
	/* DCDC OCP nmos (sticky register, clear on read) */
	TFA9894_BF_DCOCPOK = 0x1120,
	/* DCDC level 1x */
	TFA9894_BF_DCHVBAT = 0x1140,
	/* DCDC level 1.14x */
	TFA9894_BF_DCH114 = 0x1150,
	/* DCDC level 1.07x */
	TFA9894_BF_DCH107 = 0x1160,
	/* Speaker status */
	TFA9894_BF_SPKS = 0x1170,
	/* External clock status */
	TFA9894_BF_CLKOOR = 0x1180,
	/* Alarm state */
	TFA9894_BF_MANALARM = 0x1190,
	/* TDM error */
	TFA9894_BF_TDMERR = 0x11a0,
	/* TDM lookup table error */
	TFA9894_BF_TDMLUTER = 0x11b0,
	/* OCPOK pmos A */
	TFA9894_BF_OCPOAP = 0x1200,
	/* OCPOK nmos A */
	TFA9894_BF_OCPOAN = 0x1210,
	/* OCPOK pmos B */
	TFA9894_BF_OCPOBP = 0x1220,
	/* OCPOK nmos B */
	TFA9894_BF_OCPOBN = 0x1230,
	/* Amplifier clipping */
	TFA9894_BF_CLIPS = 0x1240,
	/* Audio mute sequence */
	TFA9894_BF_MANMUTE = 0x1250,
	/* Device in Operating state */
	TFA9894_BF_MANOPER = 0x1260,
	/* Low power MODE1 detection */
	TFA9894_BF_LP1 = 0x1270,
	/* Low amplitude detection */
	TFA9894_BF_LA = 0x1280,
	/* VDDP greater than VBAT flag */
	TFA9894_BF_VDDPH = 0x1290,
	/* TDM Status bits */
	TFA9894_BF_TDMSTAT = 0x1402,
	/* Device Manager status */
	TFA9894_BF_MANSTATE = 0x1433,
	/* DCDC mode status bits */
	TFA9894_BF_DCMODE = 0x14b1,
	/* Battery voltage (V) */
	TFA9894_BF_BATS = 0x1509,
	/* IC Temperature (C) */
	TFA9894_BF_TEMPS = 0x1608,
	/* IC VDDP voltage (1023*VDDP/13V) */
	TFA9894_BF_VDDPS = 0x1709,
	/* Enable interface */
	TFA9894_BF_TDME = 0x2000,
	/* Control audio tdm channel in sink0 */
	TFA9894_BF_TDMSPKE = 0x2010,
	/* Control audio tdm channel in sink1 */
	TFA9894_BF_TDMDCE = 0x2020,
	/* Source 0 enable */
	TFA9894_BF_TDMCSE = 0x2030,
	/* Source 1 enable */
	TFA9894_BF_TDMVSE = 0x2040,
	/* Source 2 enable */
	TFA9894_BF_TDMCFE = 0x2050,
	/* Source 3 enable */
	TFA9894_BF_TDMCF2E = 0x2060,
	/* Reception data to BCK clock */
	TFA9894_BF_TDMCLINV = 0x2070,
	/* FS polarity */
	TFA9894_BF_TDMFSPOL = 0x2080,
	/* Data delay to FS */
	TFA9894_BF_TDMDEL = 0x2090,
	/* Data adjustment */
	TFA9894_BF_TDMADJ = 0x20a0,
	/* Received audio compression */
	TFA9894_BF_TDMOOMP = 0x20b1,
	/* TDM NBCK - Bit clock to FS ratio */
	TFA9894_BF_TDMNBCK = 0x2103,
	/* FS length (master mode only) */
	TFA9894_BF_TDMFSLN = 0x2143,
	/* N-slots in Frame */
	TFA9894_BF_TDMSLOTS = 0x2183,
	/* Format unused bits */
	TFA9894_BF_TDMTXDFO = 0x21c1,
	/* Format unused slots DATAO */
	TFA9894_BF_TDMTXUS0 = 0x21e1,
	/* N-bits in slot */
	TFA9894_BF_TDMSLLN = 0x2204,
	/* N-bits remaining */
	TFA9894_BF_TDMBRMG = 0x2254,
	/* Sample size per slot */
	TFA9894_BF_TDMSSIZE = 0x22a4,
	/* TDM slot for sink 0 */
	TFA9894_BF_TDMSPKS = 0x2303,
	/* TDM slot for sink 1 */
	TFA9894_BF_TDMDCS = 0x2343,
	/* TDM Source 2 data selection */
	TFA9894_BF_TDMCFSEL = 0x2381,
	/* TDM Source 3 data selection */
	TFA9894_BF_TDMCF2SEL = 0x23a1,
	/* Slot Position of source 0 data */
	TFA9894_BF_TDMCSS = 0x2403,
	/* Slot Position of source 1 data */
	TFA9894_BF_TDMVSS = 0x2443,
	/* Slot Position of source 2 data */
	TFA9894_BF_TDMCFS = 0x2483,
	/* Slot Position of source 3 data */
	TFA9894_BF_TDMCF2S = 0x24c3,
	/* Status POR */
	TFA9894_BF_ISTVDDS = 0x4000,
	/* Status DCDC OCP */
	TFA9894_BF_ISTBSTOC = 0x4010,
	/* Status OTP alarm */
	TFA9894_BF_ISTOTDS = 0x4020,
	/* Status OCP alarm */
	TFA9894_BF_ISTOCPR = 0x4030,
	/* Status UVP alarm */
	TFA9894_BF_ISTUVDS = 0x4040,
	/* Status manager alarm state */
	TFA9894_BF_ISTMANALARM = 0x4050,
	/* Status TDM error */
	TFA9894_BF_ISTTDMER = 0x4060,
	/* Status lost clock */
	TFA9894_BF_ISTNOCLK = 0x4070,
	/* Status cfma error */
	TFA9894_BF_ISTCFMER = 0x4080,
	/* Status cfma ack */
	TFA9894_BF_ISTCFMAC = 0x4090,
	/* Status coolflux speaker error */
	TFA9894_BF_ISTSPKS = 0x40a0,
	/* Status cold started */
	TFA9894_BF_ISTACS = 0x40b0,
	/* Status watchdog reset */
	TFA9894_BF_ISTWDS = 0x40c0,
	/* Status brown out detect */
	TFA9894_BF_ISTBODNOK = 0x40d0,
	/* Status low power mode1 detect */
	TFA9894_BF_ISTLP1 = 0x40e0,
	/* Status clock out of range */
	TFA9894_BF_ISTCLKOOR = 0x40f0,
	/* Clear POR */
	TFA9894_BF_ICLVDDS = 0x4400,
	/* Clear DCDC OCP */
	TFA9894_BF_ICLBSTOC = 0x4410,
	/* Clear OTP alarm */
	TFA9894_BF_ICLOTDS = 0x4420,
	/* Clear OCP alarm */
	TFA9894_BF_ICLOCPR = 0x4430,
	/* Clear UVP alarm */
	TFA9894_BF_ICLUVDS = 0x4440,
	/* Clear manager alarm state */
	TFA9894_BF_ICLMANALARM = 0x4450,
	/* Clear TDM error */
	TFA9894_BF_ICLTDMER = 0x4460,
	/* Clear lost clk */
	TFA9894_BF_ICLNOCLK = 0x4470,
	/* Clear cfma err */
	TFA9894_BF_ICLCFMER = 0x4480,
	/* Clear cfma ack */
	TFA9894_BF_ICLCFMAC = 0x4490,
	/* Clear coolflux speaker error */
	TFA9894_BF_ICLSPKS = 0x44a0,
	/* Clear cold started */
	TFA9894_BF_ICLACS = 0x44b0,
	/* Clear watchdog reset */
	TFA9894_BF_ICLWDS = 0x44c0,
	/* Clear brown out detect */
	TFA9894_BF_ICLBODNOK = 0x44d0,
	/* Clear low power mode1 detect */
	TFA9894_BF_ICLLP1 = 0x44e0,
	/* Clear clock out of range */
	TFA9894_BF_ICLCLKOOR = 0x44f0,
	/* Enable POR */
	TFA9894_BF_IEVDDS = 0x4800,
	/* Enable DCDC OCP */
	TFA9894_BF_IEBSTOC = 0x4810,
	/* Enable OTP alarm */
	TFA9894_BF_IEOTDS = 0x4820,
	/* Enable OCP alarm */
	TFA9894_BF_IEOCPR = 0x4830,
	/* Enable UVP alarm */
	TFA9894_BF_IEUVDS = 0x4840,
	/* Enable Manager Alarm state */
	TFA9894_BF_IEMANALARM = 0x4850,
	/* Enable TDM error */
	TFA9894_BF_IETDMER = 0x4860,
	/* Enable lost clk */
	TFA9894_BF_IENOCLK = 0x4870,
	/* Enable cfma err */
	TFA9894_BF_IECFMER = 0x4880,
	/* Enable cfma ack */
	TFA9894_BF_IECFMAC = 0x4890,
	/* Enable coolflux speaker error */
	TFA9894_BF_IESPKS = 0x48a0,
	/* Enable cold started */
	TFA9894_BF_IEACS = 0x48b0,
	/* Enable watchdog reset */
	TFA9894_BF_IEWDS = 0x48c0,
	/* Enable brown out detect */
	TFA9894_BF_IEBODNOK = 0x48d0,
	/* Enable low power mode1 detect */
	TFA9894_BF_IELP1 = 0x48e0,
	/* Enable clock out of range */
	TFA9894_BF_IECLKOOR = 0x48f0,
	/* Polarity POR */
	TFA9894_BF_IPOVDDS = 0x4c00,
	/* Polarity DCDC OCP */
	TFA9894_BF_IPOBSTOC = 0x4c10,
	/* Polarity OTP alarm */
	TFA9894_BF_IPOOTDS = 0x4c20,
	/* Polarity ocp alarm */
	TFA9894_BF_IPOOCPR = 0x4c30,
	/* Polarity UVP alarm */
	TFA9894_BF_IPOUVDS = 0x4c40,
	/* Polarity manager alarm state */
	TFA9894_BF_IPOMANALARM = 0x4c50,
	/* Polarity TDM error */
	TFA9894_BF_IPOTDMER = 0x4c60,
	/* Polarity lost clk */
	TFA9894_BF_IPONOCLK = 0x4c70,
	/* Polarity cfma err */
	TFA9894_BF_IPOCFMER = 0x4c80,
	/* Polarity cfma ack */
	TFA9894_BF_IPOCFMAC = 0x4c90,
	/* Polarity coolflux speaker error */
	TFA9894_BF_IPOSPKS = 0x4ca0,
	/* Polarity cold started */
	TFA9894_BF_IPOACS = 0x4cb0,
	/* Polarity watchdog reset */
	TFA9894_BF_IPOWDS = 0x4cc0,
	/* Polarity brown out detect */
	TFA9894_BF_IPOBODNOK = 0x4cd0,
	/* Polarity low power mode1 detect */
	TFA9894_BF_IPOLP1 = 0x4ce0,
	/* Polarity clock out of range */
	TFA9894_BF_IPOCLKOOR = 0x4cf0,
	/* Battery safeguard attack time */
	TFA9894_BF_BSSCR = 0x5001,
	/* Battery safeguard threshold voltage level */
	TFA9894_BF_BSST = 0x5023,
	/* Battery safeguard maximum reduction */
	TFA9894_BF_BSSRL = 0x5061,
	/* Battery safeguard release time */
	TFA9894_BF_BSSRR = 0x5082,
	/* Battery Safeguard hysteresis */
	TFA9894_BF_BSSHY = 0x50b1,
	/* Battery voltage read out */
	TFA9894_BF_BSSR = 0x50e0,
	/* Bypass HW clipper */
	TFA9894_BF_BSSBY = 0x50f0,
	/* Coolflux firmware soft mute control */
	TFA9894_BF_CFSM = 0x5130,
	/* CF firmware volume control */
	TFA9894_BF_VOL = 0x5187,
	/* Clip control setting */
	TFA9894_BF_CLIPCTRL = 0x5202,
	/* Enables slope control */
	TFA9894_BF_SLOPEE = 0x5230,
	/* Slope speed setting (binary coded) */
	TFA9894_BF_SLOPESET = 0x5240,
	/* Amplifier gain */
	TFA9894_BF_AMPGAIN = 0x5287,
	...
	TFA9894_BF_TDMDCG = 0x5703,
	/* Total gain depending on INPLEV setting (channel 0) */
	TFA9894_BF_TDMSPKG = 0x5743,
	/* VAMP_OUT2 input selection */
	TFA9894_BF_DCINSEL = 0x5781,
	/* Low noise gain mode control */
	TFA9894_BF_LNMODE = 0x5881,
	/* Low power mode control */
	TFA9894_BF_LPM1MODE = 0x5ac1,
	/* TDM source mapping */
	TFA9894_BF_TDMSRCMAP = 0x5d02,
	/* Sensed value A */
	TFA9894_BF_TDMSRCAS = 0x5d31,
	/* Sensed value B */
	TFA9894_BF_TDMSRCBS = 0x5d51,
	/* Clip information (analog /digital) for source0 */
	TFA9894_BF_TDMSRCACLIP = 0x5d71,
	/* Clip information (analog /digital) for source1 */
	TFA9894_BF_TDMSRCBCLIP = 0x5d91,
	/* Delay to align compensation signal with current sense signal */
	TFA9894_BF_DELCURCOMP = 0x6102,
	/* Polarity of compensation for current sense */
	TFA9894_BF_SIGCURCOMP = 0x6130,
	/* Enable current sense compensation */
	TFA9894_BF_ENCURCOMP = 0x6140,
	/* Set the amount of pwm pulse that may be skipped before clip-flag is triggered */
	TFA9894_BF_LVLCLPPWM = 0x6152,
	/* First Boost Voltage Level */
	TFA9894_BF_DCVOF = 0x7005,
	/* Second Boost Voltage Level */
	TFA9894_BF_DCVOS = 0x7065,
	/* Max Coil Current */
	TFA9894_BF_DCMCC = 0x70c3,
	/* Slope compensation current, represents LxF (inductance x frequency) value */
	TFA9894_BF_DCCV = 0x7101,
	/* Adaptive boost mode */
	TFA9894_BF_DCIE = 0x7120,
	/* Soft ramp up/down */
	TFA9894_BF_DCSR = 0x7130,
	/* DCDC on/off */
	TFA9894_BF_DCDIS = 0x7140,
	/* DCDC PWM only mode */
	TFA9894_BF_DCPWM = 0x7150,
	/* Boost algorithm selection, effective only when boost_intelligent is set to 1 */
	TFA9894_BF_DCTRACK = 0x7160,
	/* 1st adaptive boost trip levels, effective only when DCIE is set to 1 */
	TFA9894_BF_DCENVSEL = 0x7170,
	/*!< Selection of data for adaptive boost algorithm, effective only when boost_intelligent is set to 1 */
	TFA9894_BF_DCTRIP = 0x7204,
	/* 2nd adaptive boost trip levels, effective only when DCIE is set to 1 */
	TFA9894_BF_DCTRIP2 = 0x7254,
	/* Track adaptive boost trip levels, effective only when boost_intelligent is set to 1 */
	TFA9894_BF_DCTRIPT = 0x72a4,
	/* Enable hysteresis on booster trip levels */
	TFA9894_BF_DCTRIPHYSTE = 0x72f0,
	/* Hold time for DCDC booster, effective only when boost_intelligent is set to 1 */
	TFA9894_BF_DCHOLD = 0x7304,
	/* Reset for Coolflux DSP */
	TFA9894_BF_RST = 0x9000,
	/* Target memory for CFMA using I2C interface */
	TFA9894_BF_DMEM = 0x9011,
	/* Auto increment */
	TFA9894_BF_AIF = 0x9030,
	/* Coolflux Interrupt - auto clear */
	TFA9894_BF_CFINT = 0x9040,
	/* Coolflux clock gating disabling control */
	TFA9894_BF_CFCGATE = 0x9050,
	/* Firmware event request rpc command */
	TFA9894_BF_REQCMD = 0x9080,
	/* Firmware event request reset restart */
	TFA9894_BF_REQRST = 0x9090,
	/* Firmware event request short on mips */
	TFA9894_BF_REQMIPS = 0x90a0,
	/* Firmware event request mute sequence ready */
	TFA9894_BF_REQMUTED = 0x90b0,
	/* Firmware event request volume ready */
	TFA9894_BF_REQVOL = 0x90c0,
	/* Firmware event request speaker damage detected */
	TFA9894_BF_REQDMG = 0x90d0,
	/* Firmware event request calibration completed */
	TFA9894_BF_REQCAL = 0x90e0,
	/* Firmware event request reserved */
	TFA9894_BF_REQRSV = 0x90f0,
	/* CF memory address */
	TFA9894_BF_MADD = 0x910f,
	/* Activate memory access */
	TFA9894_BF_MEMA = 0x920f,
	/* CF error flags */
	TFA9894_BF_ERR = 0x9307,
	/* Firmware event acknowledge rpc command */
	TFA9894_BF_ACKCMD = 0x9380,
	/* Firmware event acknowledge reset restart */
	TFA9894_BF_ACKRST = 0x9390,
	/* Firmware event acknowledge short on mips */
	TFA9894_BF_ACKMIPS = 0x93a0,
	/* Firmware event acknowledge mute sequence ready */
	TFA9894_BF_ACKMUTED = 0x93b0,
	/* Firmware event acknowledge volume ready */
	TFA9894_BF_ACKVOL = 0x93c0,
	/* Firmware event acknowledge speaker damage detected */
	TFA9894_BF_ACKDMG = 0x93d0,
	/* Firmware event acknowledge calibration completed */
	TFA9894_BF_ACKCAL = 0x93e0,
	/* Firmware event acknowledge reserved */
	TFA9894_BF_ACKRSV = 0x93f0,
	/* KEY2 to access KEY2 protected registers, customer key */
	TFA9894_BF_MTPK = 0xa107,
	/* Indicates KEY1 is locked */
	TFA9894_BF_KEY1LOCKED = 0xa200,
	/* Indicates KEY2 is locked */
	TFA9894_BF_KEY2LOCKED = 0xa210,
	/* Start copying all the data from mtp to I2C mtp registers - auto clear */
	TFA9894_BF_CMTPI = 0xa350,
	/* Start copying data from I2C mtp registers to mtp - auto clear */
	TFA9894_BF_CIMTP = 0xa360,
	/* MSB word of MTP manual read data */
	TFA9894_BF_MTPRDMSB = 0xa50f,
	/* LSB word of MTP manual read data */
	TFA9894_BF_MTPRDLSB = 0xa60f,
	/* External temperature (C) */
	TFA9894_BF_EXTTS = 0xb108,
	/* Select temp Speaker calibration */
	TFA9894_BF_TROS = 0xb190,
	/* Software profile data */
	TFA9894_BF_SWPROFIL = 0xe00f,
	/* Software vstep information */
	TFA9894_BF_SWVSTEP = 0xe10f,
	/* Calibration schedule */
	TFA9894_BF_MTPOTC = 0xf000,
	/* Calibration Ron executed */
	TFA9894_BF_MTPEX = 0xf010,
	/* Calibration current limit DCDC */
	TFA9894_BF_DCMCCAPI = 0xf020,
	/* Sign bit for delta calibration current limit DCDC */
	TFA9894_BF_DCMCCSB = 0xf030,
	/* Calibration delta current limit DCDC */
	TFA9894_BF_USERDEF = 0xf042,
	/* Reserved space for allowing customer to store speaker information */
	TFA9894_BF_CUSTINFO = 0xf078,
	/* Ron resistance of speaker coil */
	TFA9894_BF_R25C = 0xf50f,
...
#define TFA9894_BITNAMETABLE static tfaBfName_t Tfa9894BitNames[] = {\
	...
	{ 0xf0f, "hidden_code"}, \
	/* Hidden code to enable access to hidden register. (0x5A6B/23147 default for engineering), */\
	{ 0x1000, "flag_por"}, \
	/* POR                                               , */\
	...
	{ 0x5965, "hold_time"}, \
	/* Low noise mode hold time before entering into low noise mode, */\
	...
	/* Low power mode hold time before entering into low power mode, */\
	{ 0x5bc0, "disable_low_power_mode"}, \
	/* Low power mode1 detector control                  , */\
	{ 0x5c00, "enbl_minion"}, \
	/* Enables minion (small) power stage                , */\
	{ 0x5c13, "vth_vddpvbat"}, \
	/* Select vddp-vbat threshold signal                 , */\
	...
	/* Delay for reseting the min_vbat value inside HW Clipper (number of Fs pulses), */\
	{ 0x5e30, "rst_min_vbat_sel"}, \
	/* Control for selecting reset signal for min_bat    , */\
	{ 0x5f00, "hard_mute"}, \
	/* Hard mute - PWM                                   , */\
	...
	/* Number of zero current flags to count before going to pfm mode, */\
	...
	/* Pull down current sense LDO, only valid if enbl_cs_ldo is high, */\
	{ 0x8364, "cs_ldo_voset"}, \
	/* Current sense LDO voltage level setting (two's complement), */\
	{ 0x8800, "ctrl_vs_igen_supply"}, \
	/* Control for selecting supply for VS current generator, */\
	{ 0x8810, "ctrl_vs_force_div2"}, \
	/* Select input resistive divider gain               , */\
	...
	/* Pull down voltage sense LDO, only valid if enbl_cs_ldo is high, */\
	{ 0x8a44, "vs_ldo_voset"}, \
	/* Voltage sense LDO voltage level setting (two's complement), */\
	{ 0x8a90, "enbl_vs_adc"}, \
	/* Enable voltage sense ADC                          , */\
	{ 0x8aa0, "enbl_vs_inn1"}, \
	...
	{ 0x8ae0, "enbl_vs_ldo"}, \
	/* Enable voltage sense LDO                          , */\
	{ 0x8af0, "enbl_vs_vbatldo"}, \
	/* Enable of voltage sense LDO                       , */\
	{ 0x9000, "cf_rst_dsp"}, \
	/* Reset for Coolflux DSP                            , */\
	{ 0x9011, "cf_dmem"}, \
	/* Target memory for CFMA using I2C interface        , */\
	...
	/* Firmware event acknowledge reserved               , */\
	{ 0xa007, "mtpkey1"}, \
	/* KEY1 To access KEY1 protected registers 0x5A/90d  (default for engineering), */\
	{ 0xa107, "mtpkey2"}, \
	/* KEY2 to access KEY2 protected registers, customer key, */\
	{ 0xa200, "key01_locked"}, \
	/* Indicates KEY1 is locked                          , */\
	...
	/* Start copying single word from MTP to I2C mtp register - auto clear, */\
	{ 0xa340, "man_copy_iic_to_mtp"}, \
	/* Start copying single word from I2C mtp register to mtp - auto clear, */\
	...
	/* Disable main control change protection            , */\
	...
	/* Enable ABIST with FFT on Coolflux DSP             , */\
	...
	{ 0xc607, "digimuxa_sel"}, \
	/* DigimuxA input selection control routed to DATAO  , */\
	{ 0xc687, "digimuxb_sel"}, \
	/* DigimuxB input selection control routed to INT    , */\
	{ 0xc707, "digimuxc_sel"}, \
	/* DigimuxC input selection control routed to ADS1   , */\
	{ 0xc800, "enbl_anamux1"}, \
	/* Enable anamux1                                    , */\
	{ 0xc810, "enbl_anamux2"}, \
	/* Enable anamux2                                    , */\
	...
	{ 0xd221, "clkdiv_muxa_sel"}, \
	/* DCDC MUXA clock divider selection in direct clock control mode, */\
	{ 0xd241, "clkdiv_muxb_sel"}, \
	/* DCDC MUXB clock divider selection in direct clock control mode, */\
	{ 0xd301, "int_ehs"}, \
	/* Speed/load setting for INT IO cell, clk or data mode range (see SLIMMF IO datasheet), */\
	{ 0xd321, "datao_ehs"}, \
	/* Speed/load setting for DATAO IO cell, clk or data mode range (see SLIMMF IO datasheet), */\
	{ 0xd340, "hs_mode"}, \
	...
	/* Clock out of range                                , */\
	{ 0xd491, "sel_wdt_clk"}, \
	/* Watch dog clock divider settings                  , */\
	{ 0xd4b0, "inject_tsig"}, \
	...
	/* Disable functionality of dcdcoff_mode bit         , */\
	{ 0xf910, "mtp_lock_enbl_coolflux"}, \
	/* Disable functionality of enbl_coolflux bit        , */\
	...
	/* OCP clock auto gating                             , */\
	{ 0xf950, "mtp_gate_cgu_clock_for_test"}, \
	/* CGU test clock control                            , */\
	{ 0xf987, "type_bits_fw"}, \
	/* MTP control for firmware features - See Firmware I2C API document for details, */\
	{ 0xfa0f, "mtpdataA"}, \
	/* MTPdataA                                          , */\
	{ 0xfb0f, "mtpdataB"}, \
	/* MTPdataB                                          , */\
