...
#define TFA9891_NAMETABLE static tfaBfName_t Tfa9891DatasheetNames[] = { \
	...
	{ 0x431, "CHS12" },\
	/* Channel Selection data 2 input (coolflux input, the DCDC converter gets the other signal)*/\
	{ 0x450, "CHS3" },\
...
#define TFA9891_BITNAMETABLE static tfaBfName_t Tfa9891BitNames[] = {\
	...
	{ 0x5007, "gain"}, \
	/* gain setting of the gain multiplier gain need to increase with factor 1.41 (3dB), */\
	{ 0x5081, "ctrl_sourceb"}, \
	/* Set OUTB to                                       , */\
	{ 0x50a1, "ctrl_sourcea"}, \
	/* Set OUTA to                                       , */\
	...
	/* ABIST mode to add both amplifier halfs as stereo or one amplifier half as mono, */\
