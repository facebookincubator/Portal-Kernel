...
typedef enum nxpTfa2BfEnumList {
	...
	/* Register for the host SW to record the current active vstep */
	...
	/* Clipping A left to Vddp */
	TFA2_BF_CLIPAHL = 0x1240,
	/* Clipping A left to gnd */
	TFA2_BF_CLIPALL = 0x1250,
	/* Clipping B left to Vddp */
	TFA2_BF_CLIPBHL = 0x1260,
	/* Clipping B left to gnd */
	...
	/* Control voltage sense right */
	TFA2_BF_TDMVSRE = 0x2340,
	/* Control current sense right */
	TFA2_BF_TDMCSRE = 0x2350,
	/* Voltage sense left control */
	TFA2_BF_TDMVSLE = 0x2360,
	/* Current sense left control */
	TFA2_BF_TDMCSLE = 0x2370,
	/* DSP out right control */
	TFA2_BF_TDMCFRE = 0x2380,
	/* DSP out left control */
	TFA2_BF_TDMCFLE = 0x2390,
	/* AEC ref left control */
	...
	/* Position audio right */
	TFA2_BF_TDMRS = 0x2683,
	/* Position voltage sense right */
	TFA2_BF_TDMVSRS = 0x2703,
	/* Position current sense right */
	TFA2_BF_TDMCSRS = 0x2743,
	/* Position voltage sense left */
	TFA2_BF_TDMVSLS = 0x2783,
	/* Position current sense left */
	TFA2_BF_TDMCSLS = 0x27c3,
	/* Position dspout right */
	TFA2_BF_TDMCFRS = 0x2803,
	/* Position dspout left */
	TFA2_BF_TDMCFLS = 0x2843,
	/* Position AEC ref left control */
	TFA2_BF_TDMCF3S = 0x2883,
	/* Position AEC ref right control */
	...
	/* GPIO master control over GPIO1/2 ports (not for customer) */
	...
	/* Battery protection attack Time */
	TFA2_BF_BSSCR = 0x5001,
	/* Battery protection threshold voltage level */
	TFA2_BF_BSST = 0x5023,
	...
	/* FW volume control for secondary audio channel */
	...
	/* Soft ramp up/down */
	TFA2_BF_DCSR = 0x70a0,
	/* DCDC synchronization off + 7 positions */
	...
	/* Ron resistance of left channel speaker coil */
	TFA2_BF_R25CL = 0xf40f,
	/* Ron resistance of right channel speaker coil */
...
#define TFA2_BITNAMETABLE static tfaBfName_t Tfa2BitNames[] = {\
	...
	/* Current sense common mode feedback control for left channel, */\
	{ 0xf0f, "hidden_code"}, \
	...
	/* PDM 2 control                                     , */\
	{ 0x2401, "tdm_sink0_io"}, \
	/* IO gainin (not used in DSP)                       , */\
	{ 0x2421, "tdm_sink1_io"}, \
	/* IO audio left                                     , */\
	{ 0x2441, "tdm_sink2_io"}, \
	/* IO audio right                                    , */\
	{ 0x2461, "tdm_source0_io"}, \
	/* IO gainout (not used in DSP)                      , */\
	...
	/* Bypass control for the MICVDD OCP flag processing , */\
	{ 0x3201, "pdm_nbck"}, \
	/* PDM BCK/Fs ratio                                  , */\
	{ 0x3223, "pdm_gain"}, \
	/* PDM gain                                          , */\
	...
	/* Selection of feedback resistor for receiver mode (not for customer), */\
	{ 0x5222, "ctrl_cc"}, \
	/* Clip control setting                              , */\
	{ 0x5257, "gain"}, \
	/* Amplifier gain                                    , */\
	...
	/* DPSA Release time                                 , */\
	{ 0x5340, "clipfast"}, \
	/* Clock selection for HW clipper for battery protection, */\
	{ 0x5350, "bypass_lp"}, \
	...
	{ 0x5420, "fb_hz"}, \
	/* Feedback resistor set to high ohmic               , */\
	{ 0x5430, "icomp_engage"}, \
	/* Engage of icomp                                   , */\
	...
	{ 0x5581, "dpsa_drive"}, \
	/* Control of the number of power stage sections, total of 4 sections. Each section is 1/4 of the total power stages., */\
	{ 0x560a, "enbl_amp_left"}, \
	/* Switch on the class-D power sections, each part of the analog sections can be switched on/off individually - Left channel, */\
	{ 0x56b0, "enbl_engage_left"}, \
	/* Enables/engage power stage and control loop - left channel, */\
	{ 0x570a, "enbl_amp_right"}, \
	/* Switch on the class-D power sections, each part of the analog sections can be switched on/off individually - Right channel, */\
	{ 0x57b0, "enbl_engage_right"}, \
	/* Enables/engage power stage and control loop - right channel, */\
	{ 0x5800, "hard_mute_left"}, \
	/* Hard mute - PWM module left                       , */\
	{ 0x5810, "hard_mute_right"}, \
	/* Hard mute - PWM module right                      , */\
	{ 0x5820, "pwm_shape"}, \
	/* PWM shape                                         , */\
	{ 0x5830, "pwm_bitlength"}, \
	/* PWM bit length in noise shaper                    , */\
	{ 0x5844, "pwm_delay"}, \
	...
	/* Control for pwm phase shift, inverted function - left channel, */\
	{ 0x58c0, "enbl_pwm_phase_shift_right"}, \
	/* Control for pwm phase shift - right channel       , */\
	{ 0x5900, "ctrl_rcvldop_pulldown"}, \
	/* Pulldown of LDO (2.7V)                            , */\
	{ 0x5910, "ctrl_rcvldop_test_comp"}, \
	/* Enable testing of LDO comparator                  , */\
	{ 0x5920, "ctrl_rcvldop_test_loadedldo"}, \
	/* Load connected to rcvldo                          , */\
	{ 0x5930, "enbl_rcvldop"}, \
	/* Enables the LDO (2.7)                             , */\
	...
	/* Current sense common mode feedback pwm invert control for left channel, */\
	{ 0x8122, "cmfb_gain_left"}, \
	/* Current sense common mode feedback control gain for left channel, */\
	{ 0x8154, "cmfb_offset_left"}, \
	/* Current sense common mode feedback control offset for left channel, */\
	{ 0x8200, "enbl_cmfb_right"}, \
	/* Current sense common mode feedback control for right channel, */\
	{ 0x8210, "invertpwm_right"}, \
	/* Current sense common mode feedback pwm invert control for right channel, */\
	{ 0x8222, "cmfb_gain_right"}, \
	/* Current sense common mode feedback control gain for right channel, */\
	{ 0x8254, "cmfb_offset_right"}, \
	/* Current sense common mode feedback control offset for right channel, */\
	{ 0x8305, "cs_ktemp"}, \
	...
	/* Voltage sense decimator offset control            , */\
	{ 0x9000, "cf_rst_dsp"}, \
	/* Reset                                             , */\
	{ 0x9011, "cf_dmem"}, \
	/* Target memory                                     , */\
	...
	/* Coolflux interrupt vector table address0 MSB      , */\
	{ 0x990f, "ivt_addr0_lsb"}, \
	/* Coolflux interrupt vector table address0 LSB      , */\
	{ 0x9a0f, "ivt_addr1_msb"}, \
	/* Coolflux interrupt vector table address1 MSB      , */\
	{ 0x9b0f, "ivt_addr1_lsb"}, \
	/* Coolflux interrupt vector table address1 LSB      , */\
	{ 0x9c0f, "ivt_addr2_msb"}, \
	/* Coolflux interrupt vector table address2 MSB      , */\
	{ 0x9d0f, "ivt_addr2_lsb"}, \
	/* Coolflux interrupt vector table address2 LSB      , */\
	{ 0x9e0f, "ivt_addr3_msb"}, \
	/* Coolflux interrupt vector table address3 MSB      , */\
	{ 0x9f0f, "ivt_addr3_lsb"}, \
	/* Coolflux interrupt vector table address3 LSB      , */\
	{ 0xa007, "mtpkey1"}, \
	...
	/* Bypass ovp for memory switch diosw                , */\
	...
	{ 0xcc04, "anamux5"}, \
	/* Anamux selection control - anamux on TEST5        , */\
	{ 0xcc54, "anamux6"}, \
	/* Anamux selection control - anamux on TEST6        , */\
	{ 0xcca4, "anamux7"}, \
	/* Anamux selection control - anamux on TEST7        , */\
	{ 0xcd05, "pll_seli"}, \
	...
	/* Test signal gain for left channel                 , */\
	{ 0xd283, "tsig_gain_right"}, \
	/* Test signal gain for right channel                , */\
	{ 0xd300, "adc10_reset"}, \
	...
	/* HW gain module - right channel (2's complement)   , */\
	...
	/* Current sense gain - left channel (signed two's complement format), */\
	...
	/* Offset of left amplifier level shifter A          , */\
	{ 0xf686, "ctrl_offset_b_left"}, \
	/* Offset of left amplifier level shifter B          , */\
	{ 0xf706, "ctrl_offset_a_right"}, \
	/* Offset of right amplifier level shifter A         , */\
	{ 0xf786, "ctrl_offset_b_right"}, \
	/* Offset of right amplifier level shifter B         , */\
	...
	/* Disable function enbl_coolflux                    , */\
