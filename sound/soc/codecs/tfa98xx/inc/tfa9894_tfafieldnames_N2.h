...
typedef enum nxpTfa9894N2BfEnumList {
	...
	/*!< Enable FS synchronisation for clock divider        */
	TFA9894N2_BF_CLKREFSYNCEN = 0x0490,
	/*!< Enable PLL reference clock synchronisation for clock divider */
	TFA9894N2_BF_PLLSTUP = 0x04a0,
	/*!< PLL startup time configuration                     */
	TFA9894N2_BF_CGUSYNCDCG = 0x0500,
	/*!< Clock gating control for CGU synchronisation module */
	...
	/*!< Bypass the interpolator delay line                 */
	...
	/*!< Threshold level to activate active overshoot control */
	...
	/*!< Hold time / Hysteresis for DCDC booster, effective only when boost_intelligent is set to 1 */
	...
	/*!< PLL INSELI - PLL direct bandwidth control mode only with pll_bandsel set to 1 */
	TFA9894N2_BF_PLLINSELP = 0xca64,
	/*!< PLL INSELP - PLL direct bandwidth control mode only with pll_bandsel set to 1 */
	TFA9894N2_BF_PLLINSELR = 0xcab3,
	/*!< PLL INSELR - PLL direct bandwidth control mode only with pll_bandsel set to 1 */
	TFA9894N2_BF_PLLNDEC = 0xcb09,
	/*!< PLL NDEC in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLMDECMSB = 0xcba0,
	/*!< MSB of PLL MDEC in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLBYPASS = 0xcbb0,
	/*!< PLL bypass control during functional mode          */
	TFA9894N2_BF_PLLDIRECTI = 0xcbc0,
	/*!< PLL directi control in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLDIRECTO = 0xcbd0,
	/*!< PLL directo control in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLFRMSTBL = 0xcbe0,
	/*!< PLL FRM clock stable control in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLFRM = 0xcbf0,
	/*!< PLL free running mode control in functional mode   */
	TFA9894N2_BF_PLLMDECLSB = 0xcc0f,
	/*!< Bits 15..0 of PLL MDEC in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_PLLPDEC = 0xcd06,
	/*!< PLL PDEC in direct control mode only, use_direct_pll_ctrl set to 1 */
	TFA9894N2_BF_DIRECTPLL = 0xcd70,
	/*!< Enabled PLL direct control mode, overrules the PLL LUT with I2C register values */
	TFA9894N2_BF_DIRECTCLK = 0xcd80,
	/*!< Enabled CGU clock divider direct control mode      */
	TFA9894N2_BF_PLLLIM = 0xcd90,
	/*!< PLL up limiter control in PLL direct bandwidth control mode, pll_bandsel set to 1 */
...
#define TFA9894N2_BITNAMETABLE static tfaBfName_t Tfa9894N2BitNames[] = {\
	...
	{ 0xc0e0, "enbl_pll"}, \
	/* Enables PLL in I2C direct control mode only       , */\
	{ 0xc0f0, "enbl_osc"}, \
	/* Enables OSC in I2C direct control mode only       , */\
	{ 0xc100, "enbl_tsense"}, \
	...
	{ 0xc4d0, "test_bst_ocp"}, \
	/* Boost Converter Over Current Protection           , */\
	...
	/* PLL INSELR - PLL direct bandwidth control mode only with pll_bandsel set to 1, */\
	{ 0xcaf0, "pll_bandsel"}, \
	/* PLL bandwidth selection control, USE WITH CAUTION , */\
	{ 0xcb09, "pll_ndec"}, \
	/* PLL NDEC in direct control mode only, use_direct_pll_ctrl set to 1, */\
	{ 0xcba0, "pll_mdec_msb"}, \
	/* MSB of PLL MDEC in direct control mode only, use_direct_pll_ctrl set to 1, */\
