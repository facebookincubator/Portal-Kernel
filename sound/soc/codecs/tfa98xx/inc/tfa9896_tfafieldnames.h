...
typedef enum nxpTFA9896BfEnumList {
	/* Power-on-reset flag (auto clear by reading) */
	TFA9896_BF_VDDS = 0x0000,
	/* PLL lock to programmed frequency */
	...
	/* MTP busy copying data to/from I2C registers */
	TFA9896_BF_MTPB = 0x0080,
	/* lost clock detection (reference input clock) */
	TFA9896_BF_NOCLK = 0x0090,
	/* Speaker error */
	TFA9896_BF_SPKS = 0x00a0,
	/* Cold Start required */
	TFA9896_BF_ACS = 0x00b0,
	/* Amplifier engage (Amp Switching) */
	TFA9896_BF_SWS = 0x00c0,
	/* watchdog reset (activates reset) */
	...
	/* Battery voltage from ADC readout */
	TFA9896_BF_BATS = 0x0109,
	/* Temperature readout from the temperature sensor ( C) */
	...
	/* Input level selection attenuator ( */
	...
	/* Batteery protection attack time */
	TFA9896_BF_BSSCR = 0x0501,
	/* Battery protection threshold level */
	TFA9896_BF_BSST = 0x0523,
	/* Battery protection maximum reduction */
	...
	/* ctrl_peak2avg for analog part of DCDC */
	TFA9896_BF_DCPAVG = 0x07c0,
	/* DCDC PWM only mode */
	TFA9896_BF_DCPWM = 0x07d0,
	/* Selection ambient temperature for speaker calibration */
	TFA9896_BF_TROS = 0x0800,
	/* External temperature for speaker calibration (C) */
	TFA9896_BF_EXTTS = 0x0818,
	/* powerdown selection */
	TFA9896_BF_PWDN = 0x0900,
	/* All I2C registers reset to default */
	...
	/* Selection if Coolflux enables amplifier */
	TFA9896_BF_AMPC = 0x0960,
	/* DCDC boost converter not connected */
	TFA9896_BF_DCDIS = 0x0970,
	/* IDDQ amplifier test selection */
	TFA9896_BF_PSDR = 0x0980,
	/* INT pad (interrupt bump output) configuration */
	TFA9896_BF_INTPAD = 0x09c1,
	/* PLL input reference clock selection */
	TFA9896_BF_IPLL = 0x09e0,
	/* Adaptive boost trip levels (effective only when boost_intel is set to 1) */
	TFA9896_BF_DCTRIP = 0x0a04,
	/* Hold time for DCDC booster (effective only when boost_intel is set to 1) */
	TFA9896_BF_DCHOLD = 0x0a54,
	/* KEY2 to access key2 protected registers (default for engineering) */
	TFA9896_BF_MTPK = 0x0b07,
	/* Fractional delay adjustment between current and voltage sense */
	TFA9896_BF_CVFDLY = 0x0c25,
	/* Enable programming of the MTP memory */
	TFA9896_BF_OPENMTP = 0x0ec0,
	/* TDM usecase selection control */
	TFA9896_BF_TDMPRF = 0x1011,
	/* TDM interface enable */
	TFA9896_BF_TDMEN = 0x1030,
	/* TDM clock inversion, receive on */
	TFA9896_BF_TDMCKINV = 0x1040,
	/* TDM FS length */
	TFA9896_BF_TDMFSLN = 0x1053,
	/* TDM FS polarity (start frame) */
	TFA9896_BF_TDMFSPOL = 0x1090,
	/* TDM sample size for all TDM sinks and sources */
	TFA9896_BF_TDMSAMSZ = 0x10a4,
	/* TDM number of slots */
	TFA9896_BF_TDMSLOTS = 0x1103,
	/* TDM slot length */
	TFA9896_BF_TDMSLLN = 0x1144,
	/* TDM bits remaining after the last slot */
	...
	/* TDM TXDATA format unused slot SD1 */
	...
	/* Auto increment flag for memory-address */
	TFA9896_BF_AIF = 0x7030,
	/* CF Interrupt - auto clear */
	TFA9896_BF_CFINT = 0x7040,
	/* CF request for accessing the 8 channels */
	...
	/* CF acknowledgment of the requests channels */
	TFA9896_BF_ACK = 0x7387,
	/* Calibration schedule selection */
	TFA9896_BF_MTPOTC = 0x8000,
	/* Calibration of RON status bit */
...
#define TFA9896_BITNAMETABLE static tfaBfName_t Tfa9896BitNames[] = {\
	...
	/* Battery supply safeguard clipper reset ( if CF_DSP is bypassed), */\
	{ 0x5e0, "sel_vbat"}, \
	/* Battery voltage value for read out (only)         , */\
	...
	/* Ignore flag_voutcomp86  (flag from analog)        , */\
	{ 0x800, "ext_temp_sel"}, \
	/* Selection ambient temperature for speaker calibration , */\
	{ 0x818, "ext_temp"}, \
	/* External temperature for speaker calibration (C)  , */\
	...
	/* Coolflux sub-system clock selection               , */\
	...
	/* Voltage sense source selection                    , */\
	{ 0xc25, "vi_frac_delay"}, \
	/* Fractional delay adjustment between current and voltage sense, */\
	{ 0xc80, "sel_voltsense_out"}, \
	/* TDM output data selection for AEC                 , */\
	{ 0xc90, "vsense_bypass_avg"}, \
	/* Voltage sense average block bypass                , */\
	{ 0xd05, "cf_frac_delay"}, \
	/* Fractional delay adjustment between current and voltage sense by firmware, */\
	{ 0xe00, "bypass_dcdc_curr_prot"}, \
	/* Control to switch off dcdc current reduction with bat protection, */\
	{ 0xe10, "bypass_ocp"}, \
	/* Bypass OCP (digital IP block)                     , */\
	{ 0xe20, "ocptest"}, \
	/* ocptest (analog IP block) enable                  , */\
	{ 0xe80, "disable_clock_sh_prot"}, \
	/* Disable clock_sh protection                       , */\
	{ 0xe92, "reserve_reg_15_09"}, \
	/* Spare control bits for future usage               , */\
	{ 0xec0, "unprotect_mtp"}, \
	/* Enable programming of the MTP memory              , */\
	...
	/* DCDC number of zero current flags required to go to pfm mode, */\
	...
	/* TDM interface status bits                         , */\
	{ 0x1540, "flag_tdm_error"}, \
	/* TDM interface error indicator                     , */\
	...
	/* flag_voutcomp_int_pol                             , */\
	{ 0x2a10, "flag_voutcomp93_int_pol"}, \
	/* flag_voutcomp93_int_pol                           , */\
	{ 0x2a20, "flag_voutcomp86_int_pol"}, \
	/* flag_voutcomp86_int_pol                           , */\
	{ 0x2a30, "flag_hiz_int_pol"}, \
	/* flag_hiz_int_pol                                  , */\
	{ 0x2a40, "flag_ocpokbst_int_pol"}, \
	/* flag_ocpokbst_int_pol                             , */\
	{ 0x2a50, "flag_peakcur_int_pol"}, \
	/* flag_peakcur_int_pol                              , */\
	{ 0x2a60, "flag_ocpokap_int_pol"}, \
	/* flag_ocpokap_int_pol                              , */\
	{ 0x2a70, "flag_ocpokan_int_pol"}, \
	/* flag_ocpokan_int_pol                              , */\
	{ 0x2a80, "flag_ocpokbp_int_pol"}, \
	/* flag_ocpokbp_int_pol                              , */\
	{ 0x2a90, "flag_ocpokbn_int_pol"}, \
	/* flag_ocpokbn_int_pol                              , */\
	{ 0x2aa0, "flag_adc10_ready_int_pol"}, \
	/* flag_adc10_ready_int_pol                          , */\
	{ 0x2ab0, "flag_clipa_high_int_pol"}, \
	/* flag_clipa_high_int_pol                           , */\
	{ 0x2ac0, "flag_clipa_low_int_pol"}, \
	/* flag_clipa_low_int_pol                            , */\
	{ 0x2ad0, "flag_clipb_high_int_pol"}, \
	/* flag_clipb_high_int_pol                           , */\
	{ 0x2ae0, "flag_clipb_low_int_pol"}, \
	/* flag_clipb_low_int_pol                            , */\
	{ 0x2af0, "flag_tdm_error_int_pol"}, \
	/* flag_tdm_error_int_pol                            , */\
	{ 0x2b00, "flag_cfma_err_int_pol"}, \
	/* flag_cfma_err_int_pol                             , */\
	{ 0x2b10, "flag_cfma_ack_int_pol"}, \
	/* flag_cfma_ack_int_pol                             , */\
	{ 0x3000, "flag_voutcomp"}, \
	/* Status flag_voutcomp, indication Vset is larger than Vbat, */\
	{ 0x3010, "flag_voutcomp93"}, \
	/* Status flag_voutcomp93, indication Vset is larger than 1.07 x Vbat, */\
	{ 0x3020, "flag_voutcomp86"}, \
	/* Status flag voutcomp86, indication Vset is larger than 1.14 x Vbat, */\
	{ 0x3030, "flag_hiz"}, \
	/* Status flag_hiz, indication Vbst is larger than Vbat, */\
	...
	/* Status flag_adc10_ready, indication adc10 is ready, */\
	{ 0x30b0, "flag_clipa_high"}, \
	/* Status flag_clipa_high, indication pmos amplifier A is clipping, */\
	{ 0x30c0, "flag_clipa_low"}, \
	/* Status flag_clipa_low, indication nmos amplifier A is clipping, */\
	{ 0x30d0, "flag_clipb_high"}, \
	/* Status flag_clipb_high, indication pmos amplifier B is clipping, */\
	{ 0x30e0, "flag_clipb_low"}, \
	/* Status flag_clipb_low, indication nmos amplifier B is clipping, */\
	{ 0x310f, "mtp_man_data_out"}, \
	/* MTP manual read out data                          , */\
	{ 0x3200, "key01_locked"}, \
	/* Indicates KEY1 is locked                          , */\
	{ 0x3210, "key02_locked"}, \
	/* Indicates KEY2 is locked                          , */\
	{ 0x3225, "mtp_ecc_tcout"}, \
	/* MTP error correction test data out                , */\
	...
	/* Zero check failed for MTP                         , */\
	{ 0x3309, "data_adc10_tempbat"}, \
	/* ADC10 data output for testing battery voltage and temperature, */\
	{ 0x400f, "hid_code"}, \
	/* 5A6Bh, 23147d to access hidden registers (default for engineering), */\
	{ 0x4100, "bypass_hp"}, \
	...
	{ 0x4203, "drive"}, \
	/* Drive bits to select number of amplifier power stages, */\
	{ 0x4240, "reclock_pwm"}, \
	/* Control for enabling reclocking of PWM signal     , */\
	{ 0x4250, "reclock_voltsense"}, \
	/* Control for enabling reclocking of voltage sense signal, */\
	{ 0x4281, "dpsalevel"}, \
	...
	{ 0x4306, "drivebst"}, \
	/* Drive bits to select the power transistor sections boost converter, */\
	{ 0x4370, "boost_alg"}, \
	...
	/* FFT Coolflux                                      , */\
	{ 0x43e0, "bst_dcmbst"}, \
	/* DCM mode control for DCDC during I2C direct control mode, */\
	...
	/* Enable power stage of dcdc controller             , */\
	...
	/* Bypass PWM Counter                                , */\
	{ 0x46c0, "cs_negfixed"}, \
	/* Current sense does not switch to neg              , */\
	{ 0x46d2, "cs_neghyst"}, \
	/* Current sense switches to neg depending on hyseteris level, */\
	{ 0x4700, "switch_fb"}, \
	/* Current sense control switch_fb                   , */\
	{ 0x4713, "se_hyst"}, \
	/* Current sense control se_hyst                     , */\
	{ 0x4754, "se_level"}, \
	/* Current sense control se_level                    , */\
	{ 0x47a5, "ktemp"}, \
	/* Current sense control temperature compensation trimming, */\
	{ 0x4800, "cs_negin"}, \
	/* Current sense control negin                       , */\
	{ 0x4810, "cs_sein"}, \
	/* Current sense control cs_sein                     , */\
	{ 0x4820, "cs_coincidence"}, \
	/* Coincidence current sense                         , */\
	{ 0x4830, "iddqtestbst"}, \
	/* IDDQ testing in powerstage of DCDC boost converter, */\
	{ 0x4840, "coincidencebst"}, \
	/* Switch protection on to prevent simultaneously switching power stages bst and amp, */\
	{ 0x4876, "delay_se_neg"}, \
	/* delay of se and neg                               , */\
	{ 0x48e1, "cs_ttrack"}, \
	/* Sample and hold track time                        , */\
	{ 0x4900, "bypass_clip"}, \
	/* Bypass clip control                               , */\
	{ 0x4920, "cf_cgate_off"}, \
	/* Disable clock gating in the coolflux              , */\
	{ 0x4940, "clipfast"}, \
	...
	/* Invert se signal                                  , */\
	{ 0x49f0, "setse"}, \
	/* Switches between Single Ended and differential mode; 1 is single ended, */\
	{ 0x4a12, "adc10_sel"}, \
	...
	{ 0x4e50, "ctrl_dem"}, \
	/* Dynamic element matching control, rest of codes are optional, */\
	{ 0x4ed0, "enbl_pwm_dcc"}, \
	/* Enable direct control of pwm duty cycle           , */\
	...
	/* Control of auto-zeroing of zero current comparator, */\
	{ 0x5007, "gain"}, \
	/* Gain setting of the gain multiplier               , */\
	{ 0x5081, "sourceb"}, \
	/* PWM OUTB selection control                        , */\
	{ 0x50a1, "sourcea"}, \
	/* PWM OUTA selection control                        , */\
	{ 0x50c1, "sourcebst"}, \
	...
	{ 0x5174, "pulselength"}, \
	/* Pulse length setting test input for amplifier     , */\
	{ 0x51c0, "bypasslatch"}, \
	/* Bypass latch in PWM source selection module       , */\
	{ 0x51d0, "invertb"}, \
	...
	/* tbd for rdson testing                             , */\
	{ 0x5306, "digimuxa_sel"}, \
	/* DigimuxA input selection control (see Digimux list for details), */\
	{ 0x5376, "digimuxb_sel"}, \
	/* DigimuxB input selection control (see Digimux list for details), */\
	{ 0x5400, "hs_mode"}, \
	/* I2C high speed mode selection control             , */\
	{ 0x5412, "test_parametric_io"}, \
	/* Control for parametric tests of IO cells          , */\
	{ 0x5440, "enbl_ringo"}, \
	/* Enable ring oscillator control, for test purpose to check with ringo, */\
	{ 0x5456, "digimuxc_sel"}, \
	/* DigimuxC input selection control (see Digimux list for details), */\
	{ 0x54c0, "dio_ehs"}, \
	/* Slew control for DIO in output mode               , */\
	{ 0x54d0, "gainio_ehs"}, \
	/* Slew control for GAINIO in output mode            , */\
	{ 0x550d, "enbl_amp"}, \
	...
	{ 0x5610, "rst_datapath"}, \
	/* Reset datapath during direct control mode         , */\
	{ 0x5620, "rst_cgu"}, \
	/* Reset CGU during durect control mode              , */\
	{ 0x5637, "enbl_ref"}, \
	...
	{ 0x57f0, "reverse"}, \
	/* 1b = Normal mode, slope is controlled             , */\
	{ 0x5813, "pll_selr"}, \
	/* PLL pll_selr                                      , */\
	{ 0x5854, "pll_selp"}, \
	/* PLL pll_selp                                      , */\
	...
	/* PLL pll_seli                                      , */\
	{ 0x5950, "pll_mdec_msb"}, \
	/* Most significant bits of pll_mdec[16]             , */\
	{ 0x5960, "pll_ndec_msb"}, \
	/* Most significant bits of pll_ndec[9]              , */\
	{ 0x5970, "pll_frm"}, \
	/* PLL pll_frm                                       , */\
	{ 0x5980, "pll_directi"}, \
	/* PLL pll_directi                                   , */\
	...
	/* PLL bypass                                        , */\
	{ 0x5a0f, "tsig_freq"}, \
	/* Internal sinus test generator frequency control LSB bits, */\
	{ 0x5b02, "tsig_freq_msb"}, \
	/* Select internal sine wave generator, frequency control MSB bits, */\
	{ 0x5b30, "inject_tsig"}, \
	...
	{ 0x5c0f, "pll_mdec"}, \
	/* PLL MDEC - I2C direct PLL control mode only       , */\
	{ 0x5d06, "pll_pdec"}, \
	...
	/* Write data for MTP manual write                   , */\
	{ 0x7000, "cf_rst_dsp"}, \
	/* Reset CoolFlux DSP                                , */\
	{ 0x7011, "cf_dmem"}, \
	/* Target memory for access                          , */\
	...
	/* CF error flags                                    , */\
	{ 0x7387, "cf_ack"}, \
	/* CF acknowledgement of the requests channels       , */\
	...
	{ 0x830f, "calibr_ron"}, \
	/* calibration value of the RON resistance of the coil, */\
	{ 0x8505, "type_bits_hw"}, \
	/* bit0 = disable function dcdcoff_mode ($09[7])     , */\
	...
	/* HTOL I2C_Address_Enable                           , */\
	{ 0x8881, "ctrl_ovp_response"}, \
	/* OVP response control                              , */\
	{ 0x88a0, "disable_ovp_alarm_state"}, \
	/* OVP alarm state control                           , */\
	{ 0x88b0, "enbl_stretch_ovp"}, \
	/* OVP alram strech control                          , */\
