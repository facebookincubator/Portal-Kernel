...
typedef enum nxpTfa9912BfEnumList {
	...
	/* TDM Compatibility with TFA9872 */
	TFA9912_BF_TDMC = 0x02c0,
	/* ADC10 Enable -  I2C direct mode */
	...
	/* Coolflux DSP clock scaling, low power mode */
	TFA9912_BF_ENCFCKSEL = 0x0430,
	/* Coolflux DSP clock scaler selection for low power mode */
	TFA9912_BF_CFCKSEL = 0x0441,
	/* TDM clock selection */
	TFA9912_BF_TDMINFSEL = 0x0460,
	/* Disable Automatic dsp clock source selection */
	TFA9912_BF_DISBLAUTOCLKSEL = 0x0470,
	/* I2C selection of DSP clock when auto select is disabled */
	TFA9912_BF_SELCLKSRC = 0x0480,
	/* I2C selection of Watchdog and Timer clock */
	...
	/* Enable PGA chop clock for left channel */
	TFA9912_BF_PGALE = 0x0570,
	/* Enable PGA chop clock */
	...
	/* Over rule of vbg for FaIM access */
	TFA9912_BF_FAIMVBGOVRRL = 0x05f0,
	/* Input selection for TAP/SAM */
	TFA9912_BF_SAMSPKSEL = 0x0600,
	/* PDM2IIS Bridge enable */
	...
	/* side tone (un)mute busy */
	TFA9912_BF_STMUTEB = 0x1170,
	/* side tone mute state */
	...
	/* Status Tap comparator triggered */
	...
	/* DSP clock source selected by manager */
	TFA9912_BF_DSPCLKSRC = 0x1490,
	/* Startup Mode Selected by Manager(Read Only) */
	...
	/* Format unused bits in a slot */
	TFA9912_BF_TDMTXDFO = 0x2271,
	/* Format unused slots GAINIO */
	TFA9912_BF_TDMTXUS0 = 0x2291,
	/* Format unused slots DIO1 */
	TFA9912_BF_TDMTXUS1 = 0x22b1,
	/* Format unused slots DIO2 */
	TFA9912_BF_TDMTXUS2 = 0x22d1,
	/* Control gain (channel in 0) */
	TFA9912_BF_TDMGIE = 0x2300,
	/* Control audio  left (channel in 1 ) */
	TFA9912_BF_TDMDCE = 0x2310,
	/* Control audio right (channel in 2 ) */
	...
	/* Loopback of Audio left (channel 1) */
	TFA9912_BF_TDMES6 = 0x2390,
	/* Loopback of Audio right (channel 2) */
	TFA9912_BF_TDMES7 = 0x23a0,
	/* AEC ref right control */
	...
	/* tdm slot for audio left (channel 1) */
	TFA9912_BF_TDMDCS = 0x2643,
	/* tdm slot for audio right (channel 2) */
	TFA9912_BF_TDMSPKS = 0x2683,
	/* Slot Position of Current Sense Out */
	TFA9912_BF_TDMCSS = 0x26c3,
	/* Slot Position of Voltage sense */
	TFA9912_BF_TDMVSS = 0x2703,
	/* Slot Position of GAIN out */
	TFA9912_BF_TDMCGOS = 0x2743,
	/* Slot Position DSPout2 */
	TFA9912_BF_TDMCF2S = 0x2783,
	/* Slot Position DSPout3 */
	TFA9912_BF_TDMCF3S = 0x27c3,
	/* Slot Position of DSPout */
	TFA9912_BF_TDMCFS = 0x2803,
	/* Slot Position of loopback channel left */
	TFA9912_BF_TDMEDAT6S = 0x2843,
	/* Slot Position of loopback channel right */
	TFA9912_BF_TDMEDAT7S = 0x2883,
	/* Format unused slots D3 */
	TFA9912_BF_TDMTXUS3 = 0x2901,
	/* PDM control */
	TFA9912_BF_PDMSM = 0x3100,
	/* PDM Decimator input selection */
	TFA9912_BF_PDMSTSEL = 0x3110,
	/* Side tone input enable */
	TFA9912_BF_PDMSTENBL = 0x3120,
	/* PDM data selection for left channel during PDM direct mode */
	TFA9912_BF_PDMLSEL = 0x3130,
	/* PDM data selection for right channel during PDM direct mode */
	...
	/* PDM output selection - RE/FE data combination */
	TFA9912_BF_PDMOSEL = 0x3263,
	/* Select the source for haptic data output (not for customer) */
	...
	/* Status low power mode1 */
	TFA9912_BF_ISTLP1 = 0x4250,
	/* Status low amplitude detection */
	TFA9912_BF_ISTLA = 0x4260,
	/* Status VDDP greater than VBAT */
	TFA9912_BF_ISTVDDP = 0x4270,
	/* Status Tap  detected */
	TFA9912_BF_ISTTAPDET = 0x4280,
	/* Status Audio Mode activated */
	TFA9912_BF_ISTAUDMOD = 0x4290,
	/* Status SAM Mode activated */
	TFA9912_BF_ISTSAMMOD = 0x42a0,
	/* Status Tap  Mode Activated */
	...
	/* Clear low power mode1 */
	TFA9912_BF_ICLLP1 = 0x4650,
	/* Clear low amplitude detection */
	TFA9912_BF_ICLLA = 0x4660,
	/* Clear VDDP greater then VBAT */
	TFA9912_BF_ICLVDDP = 0x4670,
	/* Clear Tap  detected */
	TFA9912_BF_ICLTAPDET = 0x4680,
	/* Clear Audio Mode activated */
	TFA9912_BF_ICLAUDMOD = 0x4690,
	/* Clear SAM Mode activated */
	...
	/* Enable low power mode1 */
	TFA9912_BF_IELP1 = 0x4a50,
	/* Enable low amplitude detection */
	TFA9912_BF_IELA = 0x4a60,
	/* Enable VDDP greater than VBAT */
	TFA9912_BF_IEVDDP = 0x4a70,
	/* Enable Tap  detected */
	TFA9912_BF_IETAPDET = 0x4a80,
	/* Enable Audio Mode activated */
	TFA9912_BF_IEAUDMOD = 0x4a90,
	/* Enable SAM Mode activated */
	...
	/* Polarity flag_clk_out_of_range */
	...
	/* Polarity low power mode1 */
	TFA9912_BF_IPOLP1 = 0x4e50,
	/* Polarity low amplitude detection */
	TFA9912_BF_IPOLA = 0x4e60,
	/* Polarity VDDP greater than VBAT */
	TFA9912_BF_IPOVDDP = 0x4e70,
	/* PolarityTap  detected */
	TFA9912_BF_IPOLTAPDET = 0x4e80,
	/* PolarityAudio Mode activated */
	TFA9912_BF_IPOLAUDMOD = 0x4e90,
	/* PolaritySAM Mode activated */
	TFA9912_BF_IPOLSAMMOD = 0x4ea0,
	/* Polarity Tap  Mode Activated */
	TFA9912_BF_IPOLTAPMOD = 0x4eb0,
	/* PolarityTap  Comparator Trigger */
	...
	/* FW volume control for primary audio channel */
...
#define TFA9912_BITNAMETABLE static tfaBfName_t Tfa9912BitNames[] = {\
	...
	/* CF low latency outputs for add module             , */\
	...
	/* PWM shape                                         , */\
	{ 0x5844, "pwm_delay"}, \
	/* PWM delay bits to set the delay, clock is 1/(k*2048*fs), */\
	{ 0x5890, "reclock_pwm"}, \
	...
	/* low power mode1 detector   ctrl threshold for zero X-ing  , */\
	{ 0x64e1, "lpm1_mode"}, \
	/* low power mode1 detector ctrl select mode         , */\
	...
	{ 0x6700, "enbl_minion"}, \
	/* Enables minion (small) power stage - direct ctrl  , */\
	{ 0x6713, "vth_vddpvbat"}, \
	/* select vddp-vbat thres signal                     , */\
	{ 0x6750, "lpen_vddpvbat"}, \
	/* select vddp-vbat filtered vs unfiltered compare   , */\
	{ 0x6761, "ctrl_rfb"}, \
	...
	/* Sam mode                                          , */\
	{ 0x6931, "pdmdat_h_sel"}, \
	/* pdm out value when pdm_clk is higth               , */\
	{ 0x6951, "pdmdat_l_sel"}, \
	/* pdm out value when pdm_clk is low                 , */\
	{ 0x6970, "cs_sam_set"}, \
	/* Enable SAM input for current sense - I2C Direct Mode, */\
	{ 0x6980, "cs_adc_nortz"}, \
	/* Return to zero for current sense ADC              , */\
	{ 0x6990, "sam_spkr_sel"}, \
	/* SAM o/p sel during SAM and audio                  , */\
	...
	{ 0x7174, "bst_slopecur"}, \
	/* For testing direct control slope current  - I2C direct mode, */\
	{ 0x71c1, "bst_slope"}, \
	/* Boost slope speed                                 , */\
	...
	/* Enable power stage dcdc controller  - I2C direct mode, */\
	{ 0x7210, "enbl_bst_hizcom"}, \
	/* Enable hiz comparator  - I2C direct mode          , */\
	{ 0x7220, "enbl_bst_peak2avg"}, \
	/* Enable boost peak2avg functionality               , */\
	{ 0x7230, "enbl_bst_peakcur"}, \
	/* Enable peak current   - I2C direct mode           , */\
	{ 0x7240, "enbl_bst_power"}, \
	/* Enable line of the powerstage  - I2C direct mode  , */\
	{ 0x7250, "enbl_bst_slopecur"}, \
	/* Enable bit of max-current dac  - I2C direct mode  , */\
	{ 0x7260, "enbl_bst_voutcomp"}, \
	/* Enable vout comparators  - I2C direct mode        , */\
	{ 0x7270, "enbl_bst_voutcomp86"}, \
	/* Enable vout-86 comparators  - I2C direct mode     , */\
	{ 0x7280, "enbl_bst_voutcomp93"}, \
	/* Enable vout-93 comparators  - I2C direct mode     , */\
	{ 0x7290, "enbl_bst_windac"}, \
	/* Enable window dac  - I2C direct mode              , */\
	{ 0x72a5, "bst_windac"}, \
	/* for testing direct control windac  - I2C direct mode, */\
	{ 0x7300, "boost_alg"}, \
	...
	/* Current sense gain                                , */\
	{ 0x8200, "enbl_cmfb"}, \
	/* Current sense common mode feedback control        , */\
	{ 0x8210, "invertpwm"}, \
	/* Current sense common mode feedback pwm invert control, */\
	{ 0x8222, "cmfb_gain"}, \
	/* Current sense common mode feedback control gain   , */\
	{ 0x8256, "cmfb_offset"}, \
	/* Current sense common mode feedback control offset , */\
	{ 0x8305, "cs_ktemp"}, \
	/* First order temperature compensation coefficient  , */\
	{ 0x8364, "cs_ktemp2"}, \
	...
	{ 0x8700, "enbl_cs_adc"}, \
	/* Enable current sense ADC - I2C direct mode        , */\
	{ 0x8710, "enbl_cs_inn1"}, \
	/* Enable connection of current sense negative1 - I2C direct mode, */\
	{ 0x8720, "enbl_cs_inn2"}, \
	/* Enable connection of current sense negative2 - I2C direct mode, */\
	{ 0x8730, "enbl_cs_inp1"}, \
	/* Enable connection of current sense positive1      , */\
	{ 0x8740, "enbl_cs_inp2"}, \
	/* Enable connection of current sense positive2 - I2C direct mode, */\
	{ 0x8750, "enbl_cs_ldo"}, \
	/* Enable current sense LDO - I2C direct mode        , */\
	{ 0x8760, "enbl_cs_nofloating_n"}, \
	/* Connect current sense negative to gnda at transitions of booster or classd amplifiers. Otherwise floating (0), */\
	{ 0x8770, "enbl_cs_nofloating_p"}, \
	/* Connect current sense positive to gnda at transitions of booster or classd amplifiers. Otherwise floating (0), */\
	{ 0x8780, "enbl_cs_vbatldo"}, \
	/* Enable of current sense LDO -- I2C direct mode    , */\
	{ 0x8800, "volsense_pwm_sel"}, \
	/* Voltage sense PWM source selection control        , */\
	{ 0x8810, "vol_cur_sense_dc_offset"}, \
	/* voltage and current sense decimator offset control, */\
	{ 0x8902, "cursense_comp_delay"}, \
	/* To align compensation signal with current sense signal, */\
	{ 0x8930, "cursense_comp_sign"}, \
	/* To change polarity of compensation for current sense compensation, */\
	{ 0x8940, "enbl_cursense_comp"}, \
	/* To enable current sense compensation              , */\
	{ 0x9000, "cf_rst_dsp"}, \
	/* Reset                                             , */\
	{ 0x9011, "cf_dmem"}, \
	/* Target memory                                     , */\
	...
	{ 0xc038, "enbl_ref"}, \
	/* Switch on the analog references, each part of the references can be switched on/off individually -  - I2C direct mode, */\
	{ 0xc0d0, "enbl_ringo"}, \
	...
	/* Bit to set the biasing in temp sensor to high  - I2C direct mode, */\
	{ 0xc120, "enbl_flag_vbg"}, \
	/* Enable flagging of bandgap out of control         , */\
	{ 0xc130, "tap_comp_enable"}, \
	/* Tap Comparator enable control - I2C direct mode   , */\
	{ 0xc140, "tap_comp_switch_enable"}, \
	/* Tap Comparator Switch enable control - I2C direct mode, */\
	{ 0xc150, "tap_comp_switch_aux_enable"}, \
	/* Tap Comparator Switch enable control - I2C direct mode, */\
	{ 0xc161, "tap_comp_test_enable"}, \
	/* Comparator threshold - fine value                 , */\
	{ 0xc180, "curdist_enable"}, \
	/* Enable control - I2C direct mode                  , */\
	{ 0xc190, "vbg2i_enbl"}, \
	/* Enable control - I2C direct mode                  , */\
	...
	/* Test mode for digital power switches  core sw/mem sw/micvdd sw, */\
	...
	/* Vddd core power switch control - overrules the manager control, */\
	{ 0xc707, "digimuxa_sel"}, \
	...
	{ 0xc9c0, "int_ehs"}, \
	/* Slew Rate INT IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	{ 0xc9d0, "pdmclk_ehs"}, \
	/* Slew RateBCK2/PDMCLK IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	{ 0xc9e0, "fs2_ehs"}, \
	/* Slew Rate DS2 IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	{ 0xc9f0, "hs_mode"}, \
	...
	{ 0xcc05, "pll_seli_lbw"}, \
	/* PLL SELI - Low B/W PLL control mode or I2C direct PLL control mode only, */\
	{ 0xcc64, "pll_selp_lbw"}, \
	/* PLL SELP - Low B/W PLL control mode or I2C direct PLL control mode only, */\
	{ 0xccb3, "pll_selr_lbw"}, \
	/* PLL SELR - Low B/W PLL control mode or I2C direct PLL control mode only, */\
	{ 0xccf0, "sel_user_pll_bw"}, \
	/* PLL Low Bandwidth Mode control                    , */\
	{ 0xcdf0, "pll_frm"}, \
	...
	{ 0xcec0, "enbl_fro8"}, \
	/* Enables FRO8M in I2C direct control mode only     , */\
	{ 0xced0, "pll_bypass"}, \
	...
	/* DSP clock divider selection in direct clock control mode, */\
	...
	{ 0xd681, "dsp_tap_clk"}, \
	/* Dsp clock frequency selection in TAP mode;        , */\
	{ 0xd6a1, "sel_wdt_clk"}, \
	/* Watch dog clock post divider value                , */\
	{ 0xd6c1, "sel_tim_clk"}, \
	/* Timer clock post divider value                    , */\
	{ 0xd700, "ads1_ehs"}, \
	/* Slew Rate ADS1 IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	{ 0xd710, "ads2_ehs"}, \
	/* Slew Rate ADS2 IO cell, clk or data mode range (see IIC3V3 IO cell datasheet), */\
	...
	/* Overrule Value                                    , */\
	{ 0xed00, "enbl_fro8cal"}, \
	/* Enable FRO  calibration                           , */\
	{ 0xed10, "start_fro8_calibration"}, \
	/* Start FRO8 Calibration                            , */\
	{ 0xed20, "fro8_calibration_done"}, \
	/* FRO8 Calibration done - Read Only                 , */\
	...
	/* HW gain module - left channel (2's complement)    , */\
	{ 0xf1a5, "spare_mtp1_15_10"}, \
	/* Offset for amplifier, HW gain module - left channel (2's complement), */\
	{ 0xf203, "calibr_gain"}, \
	...
	/* Auto clock gating on pwm_delay                    , */\
	{ 0xf620, "mtp_ocp_enbl_clk_auto_gating"}, \
	/* Auto clock gating on module ocp                   , */\
	{ 0xf630, "mtp_disable_clk_a_gating"}, \
	/* Disable clock_a gating                            , */\
	{ 0xf642, "spare_mtp6_6_3"}, \
	/* SPARE                                             , */\
	{ 0xf686, "spare_mtp6_14_8"}, \
	/* Offset of left amplifier level shifter B          , */\
	...
	/* Disable programming of max dcdc boost voltage     , */\
	...
	{ 0xff05, "fro8_trim"}, \
	/* 8 MHz oscillator trim code                        , */\
	{ 0xff61, "fro8_short_nwell_r"}, \
	/* Short 4 or 6 n-well resistors                     , */\
	{ 0xff81, "fro8_boost_i"}, \
	/* Self bias current selection                       , */\
