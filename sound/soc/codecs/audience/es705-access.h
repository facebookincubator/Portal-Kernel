...
static struct escore_api_access es705_api_access[ES705_API_ADDR_MAX] = {
	...
	[ES705_PORT_WORD_LEN] = {
		.read_msg = { ES_API_WORD(ES705_GET_DEV_PARAM, 0x0000) },
		.read_msg_len = 4,
		.write_msg = { ES_API_WORD(ES705_SET_DEV_PARAM_ID, 0x0000),
			ES_API_WORD(ES705_SET_DEV_PARAM, 0x0000) },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 65535,
	},
	...
	[ES705_PORT_CLOCK_CONTROL] = {
		.read_msg = { ES_API_WORD(ES705_GET_DEV_PARAM, 0x0009) },
		.read_msg_len = 4,
		.write_msg = { ES_API_WORD(ES705_SET_DEV_PARAM_ID, 0x0009),
			ES_API_WORD(ES705_SET_DEV_PARAM, 0x0000) },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 65535,
