...
static DEVICE_ATTR(route_status, 0440, es755_route_status_show, NULL);
...
static DEVICE_ATTR(pm_enable, 0660, es755_get_pm_enable, es755_set_pm_enable);
...
static DEVICE_ATTR(fw_version, 0440, es755_fw_version_show, NULL);
...
static DEVICE_ATTR(clock_on, 0440, es755_clock_on_show, NULL);
...
static DEVICE_ATTR(reset_control, 0440, es755_reset_control_show, NULL);
...
static DEVICE_ATTR(ping_status, 0440, es755_ping_status_show, NULL);
...
static DEVICE_ATTR(power_state, 0440, es755_power_state_show, NULL);
...
static DEVICE_ATTR(codec_reg_dump, 0660, codec_reg_dump_show,
