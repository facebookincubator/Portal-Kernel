/*
 * es-a375.c  --  Audience eS857 ALSA SoC Audio driver
 *
 * Copyright 2015 Audience, Inc.
 *
 * Author: Jeffrey Ke <jke@audience.com>
 *
 *
...
const struct snd_soc_dapm_widget es_codec_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("DMIC0 Clock enable", ES_DMIC_CLK_EN0,
			ES_DMIC_CLK_EN0_SHIFT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("DMIC1 Clock enable", ES_DMIC_CLK_EN1,
			ES_DMIC_CLK_EN1_SHIFT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("DMIC2 Clock enable", ES_DMIC_CLK_EN2,
			ES_DMIC_CLK_EN2_SHIFT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("DMIC3 Clock enable", ES_DMIC_CLK_EN3,
	...
	SND_SOC_DAPM_PGA("PDM0_PGA", ES_DMIC_CLK_EN0, ES_DMIC_CLK_EN0_SHIFT,
			0, NULL, 0),
	SND_SOC_DAPM_PGA("PDM1_PGA", ES_DMIC_CLK_EN1, ES_DMIC_CLK_EN1_SHIFT,
			0, NULL, 0),
	SND_SOC_DAPM_PGA("PDM2_PGA", ES_DMIC_CLK_EN2, ES_DMIC_CLK_EN2_SHIFT,
			0, NULL, 0),
	SND_SOC_DAPM_PGA("PDM3_PGA", ES_DMIC_CLK_EN3, ES_DMIC_CLK_EN3_SHIFT,
			0, NULL, 0),
};
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"DMIC0", NULL, "DMIC0 Clock enable"},
	{"DMIC1", NULL, "DMIC1 Clock enable"},
	{"DMIC2", NULL, "DMIC2 Clock enable"},
	{"DMIC3", NULL, "DMIC3 Clock enable"},

	{"DMIC0 Clock enable", NULL, "MIC0 Bias"},
	{"DMIC1 Clock enable", NULL, "MIC1 Bias"},
	{"DMIC2 Clock enable", NULL, "MIC2 Bias"},
	{"DMIC3 Clock enable", NULL, "MIC3 Bias"},
