/*
 * esn100-routes.h  --  Audience esn100 ALSA SoC Dummy Audio driver
 *
...
#ifndef _ESN100_ROUTES_H
#define _ESN100_ROUTES_H
...
static const struct esxxx_route_config esn100_route_config[ROUTE_MAX] = {
	[ROUTE_OFF] = {
		.route = route_off,
	},
