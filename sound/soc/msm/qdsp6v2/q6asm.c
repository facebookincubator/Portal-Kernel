				      ...
				      uint16_t mode)
{
	return q6asm_enc_cfg_blk_pcm_v5(ac, rate, channels,
					bits_per_sample,
#ifdef CONFIG_SND_SOC_QDSP6V2_CAPTURE_CHANNEL_MAP
					use_default_map, false, channel_map,
#else
					true, false, NULL,
#endif
					sample_word_size,
 ...
 * @rate: sample rate
 * @channels: number of channels
 * @use_default_chmap: 1 use default map, 0: use given chammel_map
 * @channel_map: channel map will be applied if use_default_chmap is 0
 * @bits_per_sample: bit width of encoder session
 * @sample_word_size: Size in bits of the word that holds a sample of a channel
 * @endianness: endianness of the pcm data
 * @mode: Mode to provide additional info about the pcm input data
