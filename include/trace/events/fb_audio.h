...
TRACE_EVENT(fba_fw_crash,
	...
	TP_printk("reason = %s", __entry->reason)
);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(fba_voice_trigger);
EXPORT_TRACEPOINT_SYMBOL_GPL(fba_fw_crash);
EXPORT_TRACEPOINT_SYMBOL_GPL(fba_usecase);
#endif
