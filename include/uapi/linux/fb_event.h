...
union fb_tas5805m_faultz_event {
	int32_t value;
	struct {
		int32_t ch1_dc:1;	/* Left channel DC */
		int32_t ch2_dc:1;	/* Right channel DC */
		int32_t ch1_oc:1;	/* Left ch. over current */
		int32_t ch2_oc:1;	/* Right ch. over current */
		int32_t otp_crc:1;	/* OTP CRC check error */
		int32_t bq_wr:1;	/* BQ is written failed */
		int32_t clk:1;		/* Clock fault */
		int32_t pvdd_ov:1;	/* PVDD Over Voltage fault */
		int32_t pvdd_uv:1;	/* PVDD Under Voltage  fault */
		int32_t otsd:1;		/* Over temp. shut down fault */
		int32_t otw:1;		/* Over temp. warning ,135C */
		int32_t amp_index:4;	/* Amplifier index*/
		int32_t reserved:17;	/* Reserved */
	};
} __packed;
