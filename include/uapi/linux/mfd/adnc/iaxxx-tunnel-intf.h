...
#define TUNNEL_SUBSCRIBE_CS2		_IO('K', 0x01d)
#define TUNNEL_UNSUBSCRIBE_CS2		_IO('K', 0x01e)
#define TUNNEL_SUBSCRIBE_AEC_REF1	_IO('K', 0x01f)
#define TUNNEL_UNSUBSCRIBE_AEC_REF1	_IO('K', 0x020)
#define TUNNEL_SUBSCRIBE_AEC_REF2	_IO('K', 0x021)
#define TUNNEL_UNSUBSCRIBE_AEC_REF2	_IO('K', 0x022)
