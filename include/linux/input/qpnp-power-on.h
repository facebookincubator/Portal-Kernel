...
enum pon_restart_reason {
	...
	/* 16 ~ 63 for OEMs/ODMs secific features
	 * Warning: Kept at 0x10 for backwards compatibility
	 * with existing Aloha Oreo bootloaders. */
	PON_RESTART_REASON_OEM_MIN		= 0x10,
