...
struct msm_ext_disp_vend_prod_edid_blk {
	u8 *vend_prod_blk;
	u32 blk_size; /* in bytes */
};
 ...
 * @get_vend_prod_edid_blk: retirive vendor/product edid block;
 */
struct msm_ext_disp_audio_codec_ops {
	...
	int (*get_vend_prod_edid_blk)(struct platform_device *pdev,
