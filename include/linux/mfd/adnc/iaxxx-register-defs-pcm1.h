/*
* iaxxx-register-defs-pcm1.h -- IAXXX register defination for pcm1
*
...
#define IAXXX_PCM1_REGS_ADDR (0x50043000)

/*** IAXXX_PCM1_SWLR (0x50043024) ***/
/* Static Word Length Register */
#define IAXXX_PCM1_SWLR_ADDR (0x50043024)
...
/*** IAXXX_PCM1_SFLR (0x50043028) ***/
/* Static Frame Length Register */
#define IAXXX_PCM1_SFLR_ADDR (0x50043028)
...
/*** IAXXX_PCM1_STDD (0x5004302c) ***/
/* Transmit data delay Register */
#define IAXXX_PCM1_STDD_ADDR (0x5004302c)
...
/*** IAXXX_PCM1_SRDD (0x50043030) ***/
/* Receive data delay Register */
#define IAXXX_PCM1_SRDD_ADDR (0x50043030)
...
/*** IAXXX_PCM1_STSA (0x50043034) ***/
/* Static Transmit Slots Active Register */
#define IAXXX_PCM1_STSA_ADDR (0x50043034)
...
/*** IAXXX_PCM1_SRSA (0x50043038) ***/
/* Static Receive Slots Active Register */
#define IAXXX_PCM1_SRSA_ADDR (0x50043038)
...
/*** IAXXX_PCM1_MC (0x50043040) ***/
/* Miscellaneous Control Register */
#define IAXXX_PCM1_MC_ADDR (0x50043040)
...
/*** IAXXX_PCM1_RIS (0x50043050) ***/
/* Raw Interrupt Status */
#define IAXXX_PCM1_RIS_ADDR (0x50043050)
#define IAXXX_PCM1_RIS_MASK_VAL 0x00070007
#define IAXXX_PCM1_RIS_RMASK_VAL 0x00070007
#define IAXXX_PCM1_RIS_WMASK_VAL 0x00070007
...
/*** IAXXX_PCM1_ISEN (0x50043054) ***/
/* Interrupt Status Enable */
#define IAXXX_PCM1_ISEN_ADDR (0x50043054)
#define IAXXX_PCM1_ISEN_MASK_VAL 0x00070007
#define IAXXX_PCM1_ISEN_RMASK_VAL 0x00070007
#define IAXXX_PCM1_ISEN_WMASK_VAL 0x00070007
#define IAXXX_PCM1_ISEN_RESET_VAL 0x00070007
