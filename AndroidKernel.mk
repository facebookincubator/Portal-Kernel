...
kernel_config_path = $(TARGET_KERNEL_SOURCE)/arch/$(KERNEL_ARCH)/configs/$(1)
...
$(KERNEL_CONFIG): $(KERNEL_OUT) $(call kernel_config_path,$(KERNEL_DEFCONFIG))
	...
	$(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) oldconfig;
...
kernelconfig: $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	cp $(KERNEL_OUT)/defconfig $(call kernel_config_path,$(KERNEL_DEFCONFIG))
